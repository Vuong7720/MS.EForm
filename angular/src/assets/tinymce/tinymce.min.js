...
!(function () {
  ...
  const Vo = '\ufeff',
          ...
          (e, t) =>
            (e => -1 !== ' \f\t\v'.indexOf(e))(t) || t === qo
              ? e.pcIsSpace ||
                ...
                ((e, t) => t < e.length && t >= 0 && Go(e[t]))(s, e.str.length + 1)
    ...
    br = ar('false'),
    vr = e =>
      er(e) && e.isContentEditable && C(e.parentElement) && !e.parentElement.isContentEditable,
    yr = nr(['td', 'th']),
    Cr = nr(['td', 'th', 'caption']),
  ...
  const Nr = (e, t, n, o) =>
    ...
    Rr = (e, t, n, o) =>
      ...
      ((e, t) => Jo(e) && Se(t.getNonEmptyElements(), e.nodeName))(t, e) ||
      kr(t) ||
      (e =>
        Jo(e) &&
        'A' === e.nodeName &&
    ...
    os = (e, t = {}) => {
      ...
      return {
        ...
        loadRawCss: (e, t) => {
          ...
          en(r, { rel: 'stylesheet', type: 'text/css', id: n.id, 'data-mce-key': e }),
            (r.dom.innerHTML = t),
            a(r);
        },
        loadAll: e =>
    ...
    Gs = (e, t) => {
      const n = null != t ? t : {};
      for (const t in e) Se(Ys, t) || (n[t] = e[t]);
      return (
        ...
        if (t) {
          ...
          for (; s--; ) {
            ...
            if (a) {
              ...
              (n && 0 !== a.length) ||
                (delete r[t], Js(e, a.fakeName || t, a.nativeHandler, a.capture));
            }
          }
        } else
          pe(r, (t, n) => {
  ...
  const oa = Dt.each,
    ...
    ua = (e, t, n) => {
      ...
      y(n) || '' === n
        ? go(e, o)
        : io(e, o, ((e, t) => (E(e) ? (Se(aa, t) ? e + '' : e + 'px') : e))(n, o));
    },
    ma = (e, t = {}) => {
      const n = {},
        o = window,
  ...
  const pa = {},
    ...
    va = {
      ...
      translate: e => {
        ...
        if (o(e)) return '';
        if (f((a = e)) && Se(a, 'raw')) return n(e.raw);
        var a;
  ...
  const La = e => {
    ...
    di = e => {
      const t = e.container();
      return (
        !!lr(t) && (t.data.charAt(e.offset()) === ei || (e.isAtStart() && ai(t.previousSibling)))
      );
    },
    ci = e => {
      const t = e.container();
      return (
        !!lr(t) && (t.data.charAt(e.offset() - 1) === ei || (e.isAtEnd() && ai(t.nextSibling)))
      );
    },
    ...
    bi = (e, t) => (
      (e = hi(e)), t || (e.left = e.left + e.width), (e.right = e.left), (e.width = 0), e
    ),
          ...
          (n = (e => {
            const t = [],
              ...
              o = (e, t) => {
                ...
                t > 0 && (o.setStart(e, t - 1), o.setEnd(e, t), Xi(o) || n(Ji(Qi(o), !1))),
                  t < e.data.length &&
                    (o.setStart(e, t), o.setEnd(e, t + 1), Xi(o) || n(Ji(Qi(o), !0)));
              },
              r = e.container(),
              s = e.offset();
  ...
  const tl = (e, t) => {
    ...
    il = e =>
      e
        ? Be(
            e.childNodes,
            (e, t) => (rl(t) && 'BR' !== t.nodeName ? (e = e.concat(il(t))) : e.push(t), e),
            []
          )
        : [],
    ll = e => t => e === t,
    ...
    Sl = { value: El, error: xl, fromOption: (e, t) => e.fold(() => xl(t), El) },
    _l = e => {
  ...
  const kl = e => 'inline-command' === e.type || 'inline-format' === e.type,
    ...
    Rl = e => {
      var t;
      const n = t => Sl.error({ message: t, pattern: e }),
        o = (t, o, r) => {
          if (void 0 !== e.format) {
            let r;
            if (p(e.format)) {
    ...
    _u = (e, t, n) => {
      ...
      if (si(a)) {
        ...
        if ('after' === t && ((o = e.previousSibling), ou(o))) return Su(o);
      }
      ...
      if (lr(a)) {
        ...
        if (ui(a) && i <= 1) return -1 === e && ((o = r(a)), o) ? Su(o) : n;
        if (i === a.data.length) return (o = s(a)), o ? xu(o) : n;
        if (0 === i) return (o = r(a)), o ? Su(o) : n;
      }
      return n;
    },
    ...
    Lu = Di,
    Mu = e =>
      Oi(e) || (e => !!Li(e) && !X(ce(e.getElementsByTagName('*')), (e, t) => e || ki(t), !1))(e),
    Iu = Mi,
    ...
    Wu = (e, t, n) =>
      qu(e, t, n).bind(o =>
        ...
        ((e, t, n) => {
          return e
            ? !Vu(t, n) && ((o = t), !(!el.isTextPosition(o) && gr(o.getNode()))) && $u(t) && Hu(n)
            : !Vu(n, t) && Hu(t) && $u(n);
          var o;
        })(e, n, o)
          ? qu(e, t, o)
    ...
    sm = (e, t) => (
      Jo(t) && e.isBlock(t) && !t.innerHTML && (t.innerHTML = '<br data-mce-bogus="1" />'), t
    ),
    am = (e, t) =>
      Qu(e).fold(
        L,
    ...
    mm = (e, t) => {
      ((e, t) => {
        ...
        if (t) {
          ...
          if ((e => Se(e, 'rng'))(t)) return I.some({ range: t.rng, forward: rm(t) });
        }
        return I.none();
    ...
    cf = (e, t, n, o, r, s) => {
      ...
      for (; a; ) {
        ...
        for (let t = a[i]; t; t = t[i]) {
          ...
          if (
            !Zm(t) &&
            (!gr((d = t)) || !d.getAttribute('data-mce-bogus') || d.nextSibling) &&
            !Jm(t, n)
          )
            return a;
        }
      ...
      return (
        ...
        (qm(m) || Wm(m)) &&
          ...
          qm(m) &&
            ...
            e.isBlock(c) || ((c = cf(e, n, c, u, !1, s)), lr(c) && (u = c.data.length)))),
    ...
    vf = e => {
      ...
      ((e, t) => {
        const n = xa(),
          ...
          r = e => {
            var t, n;
            e.attr(Sa(), null), e.attr(xa(), null), e.attr(_a(), null);
        ...
        r = e => {
          q(e, e => {
            o(e)
              ? xo(e)
              : (e => {
                  gn(e, Ea()), rn(e, `${Sa()}`), rn(e, `${xa()}`), rn(e, `${_a()}`);
                  const t = nn(e, `${Na()}`)
                      .map(e => e.split(','))
                      .getOr([]),
                    n = nn(e, `${ka()}`)
  ...
  const Cf = (e, t, n) =>
    ...
    _f = (e, t, n, o) => ({ start: e, soffset: t, finish: n, foffset: o }),
    kf = _l([{ before: ['element'] }, { on: ['element', 'offset'] }, { after: ['element'] }]),
    Nf = {
      before: kf.before,
      on: kf.on,
      after: kf.after,
  ...
  const jf = ma.DOM,
    ...
    $f = (e, t) => {
      const n = jd(e),
        o = jf.getParent(
          t,
          t => (e => Jo(e) && Ff.isEditorUIElement(e))(t) || (!!n && e.dom.is(t, n))
        );
      return null !== o;
    },
    Vf = e => {
    ...
    Wf = (e, t) => {
      e.focusedEditor === t.editor && (e.focusedEditor = null),
        !e.activeEditor && zf && (jf.unbind(document, 'focusin', zf), (zf = null));
    },
    Kf = (e, t) => {
      ((e, t) =>
        (e => (e.collapsed ? I.from(xi(e.startContainer, e.startOffset)).map(Cn) : I.none()))(
          t
        ).bind(t => (Ga(t) ? I.some(t) : kn(e, t) ? I.none() : I.some(e))))(Cn(e.getBody()), t)
        .bind(e => Zu(e.dom))
        .fold(
          () => {
      ...
      e.inline
        ? (e => {
            ...
            return (
              t &&
              ((n = Cn(t)),
              xf(n) || ((o = n), Sf($n(o)).filter(e => o.dom.contains(e.dom))).isSome())
            );
            var n, o;
          })(e)
  ...
  const lg = (e, t) => {
        ...
        return ((e, t) => {
          ...
          return n.collapsed
            ? t
                ...
                .map(e =>
                  ag.rtl(Cn(e.endContainer), e.endOffset, Cn(e.startContainer), e.startOffset)
                )
    ...
    fg = (e, t, n) =>
      ((e, t, n) =>
        ((e, t, n) =>
          ...
          _f(Cn(e.startContainer), e.startOffset, Cn(e.endContainer), e.endOffset)
        ))(e, t, n),
    gg = (e, t, n) => {
      const o = An(Cn(n));
      return fg(o.dom, e, t)
    ...
    wg = (e, t, n, o) => {
      ...
      if (
        (Jo(i) && l > i.childNodes.length - 1 && (u = !1), mr(i) && ((i = r), (l = 0)), i === r)
      ) {
  ...
  const xp = ['font', 'text-decoration', 'text-emphasis'],
    ...
    zp = Tp(!1, Bp),
    jp = (e, t) =>
      ((e, t, n) => (kn(t, e) ? Bn(e, e => n(e) || _n(e, t)).slice(0, -1) : []))(e, t, L),
    ...
    eh = (e, t, n) =>
      (e => I.from(e.getNode(!0)).map(Cn))(t).exists(qa) || Qp(!1, e, t, n).isSome(),
    th = T(Qp, !1),
    nh = T(Qp, !0),
    ...
    hh = (e, t, n, o) => {
      ...
      return n || !fh(r, r.length - 1) || mh(e, s, o)
        ? !!(n && gh(r, r.length - 1) && uh(e, s, o)) && ((t.data = r.slice(0, -1) + qo), !0)
          ...
          (e => {
            const t = e.data,
              n = (e => {
                const t = e.split('');
                return V(t, (e, n) =>
                  gm(e) && n > 0 && n < t.length - 1 && bm(t[n - 1]) && bm(t[n + 1]) ? ' ' : e
                ).join('');
              })(t);
    ...
    xh = e => {
      return Di(e.previousSibling)
        ? I.some(((t = e.previousSibling), lr(t) ? el(t, t.data.length) : el.after(t)))
        : e.previousSibling
        ...
        e
          ? ((e, t) =>
              Sh(t)
                .orThunk(() => xh(t))
                .orThunk(() =>
                  ((e, t) => Gu(e, el.after(t)).orThunk(() => Xu(e, el.before(t))))(e, t)
                ))(t, n)
          : ((e, t) =>
              xh(t)
                .orThunk(() => Sh(t))
    ...
    Oh = e => {
      ...
      return (
        ...
        (e => Ah.test(e))(null !== (t = e.textContent) && void 0 !== t ? t : '')
      );
    },
    Bh = (e, t, n) => {
    ...
    eb = (e, t) => J(e, e => _n(e, t)),
    tb = e =>
      It(eb(e.cells, e.rng.start), eb(e.cells, e.rng.end), (t, n) => e.cells.slice(t, n + 1)),
    nb = (e, t) => {
        ...
        const o = e.selection.getRng(),
          r = n
            .bind(({ rng: n, isStartInTable: r }) => {
              ...
              return (
                sb(e, a, o, r), Tr(e.schema, a) ? I.none() : I.some(r ? t.slice(1) : t.slice(0, -1))
              );
            })
            .getOr(t);
        rb(r), ab(e);
              ...
              Tr(e.schema, o, { checkRootAsContent: !1 })
                ...
                : ((e, t, n, o, r) =>
                    Wu(n, e.getBody(), r).bind(e =>
                      ub(t, Cn(e.getNode())).bind(e => (_n(e, o) ? I.none() : I.some(S)))
                    ))(e, n, t, o, r)
            );
          })(e, t, o, n).orThunk(() =>
            Ft(
            ...
            return 0 !== n.length
              ...
              : ((e, t, n, o) =>
                  mb(t, o).fold(
                    () =>
                      ((e, t, n) =>
                        ob(t, n).bind(t => t.fold(T(db, e), T(cb, e), T(ib, e), T(lb, e))))(
                        e,
                        t,
                        n
                      ),
      ...
      for (let n = 0; n < e.length; n++) {
        ...
        if (c && f.length > 1)
          if (Ob(t, i, c)) Ab(i, t);
            ...
            Nb(t, s, a, u) ? c.insert(i, f[0], !0) : (c.insert(u, f[0], !0), c.insert(i, u)),
              (c = f[0]),
      ...
      m === f &&
        ...
        s.isCollapsed() ||
          (e => {
            ...
            ((e, t, n) => !!C(n) && n === e.getParent(t.endContainer, Ub) && Sm(Cn(n), t))(t, n, o)
              ? db(e, n, Cn(o))
        ...
        ((e, t) => {
          ...
          if (t) {
            ...
            Dt.each(a, e => {
              ...
              if (
                !_p(o, (l = e)) &&
                !((e, t) => _p(e, t) && $(Sp(e, t), e => (e => Ep.has(e))(e)))(o, l) &&
                a(e) &&
                i(e)
              ) {
                const n = Sp(o, e),
                  ...
                  d = t =>
                    ...
                    o.is(t, s) &&
                    a(t) &&
                    ((t.nodeName === e.nodeName && l(n, Sp(o, t))) || d(t.children[0])),
    ...
    ev = e => {
      const t = vn('span');
      return (
        en(t, { id: Ju, 'data-mce-bogus': '1', 'data-mce-type': 'format-caret' }),
        e && vo(t, yn(Qb)),
        t
      );
    },
  ...
  const fv = ['fontWeight', 'fontStyle', 'color', 'fontSize', 'fontFamily'],
    ...
    hv = (e, t) =>
      !1 === Gu(t, el.fromRangeEnd(e)).exists(e => !gr(e.getNode()) || Gu(t, e).isSome()),
    ...
    Bv = (e, t, n) => {
      ...
      return (
        lr(o) && n && r >= o.data.length && (o = new $o(o, e.getBody()).next() || o),
          ...
          const s = e.formatter.get(t),
            ...
            m = e => {
              ...
              if (t) {
                ...
                return (
                  (e => fm(e) && Jo(e) && ('_start' === e.id || '_end' === e.id))(n) &&
            ...
            f = t => {
              ...
              if (a.split) {
                if (((r = Sg(r)), (n = Bv(e, r, !0)), (o = Bv(e, r)), n !== o)) {
                  ...
                  (n = Dv(i, n, 'span', { id: '_start', 'data-mce-type': 'bookmark' })),
                    (o = Dv(i, o, 'span', { id: '_end', 'data-mce-type': 'bookmark' }));
                  const e = i.createRng();
                  e.setStartAfter(n),
                    e.setEndBefore(o),
                    ff(i, e, e => {
                  ...
                  (s.exact ||
                    ...
                    (a = (e => {
                      const t = Q(e.childNodes, Tm).filter(
                        e => 'false' !== o.getContentEditable(e) && Yb(o, e, s)
                      );
                      return t
                        .map(t => {
                          const n = o.clone(t, !1);
                  ...
                  ((e, t, n, o, r) => {
                    ...
                    (Xb(e, s, n, o) && $v(e, t, o, r)) ||
                      (t.merge_with_parents &&
                        s &&
                        e.dom.getParent(s, s => !!Xb(e, s, n, o) && ($v(e, t, o, r), !0)));
                  })(e, s, t, n, a),
                  ((e, t, n, o) => {
                    if (t.styles && t.styles.backgroundColor) {
                      ...
                      Sv(
                        ...
                        kv(e, 'backgroundColor', Fm(t.styles.backgroundColor, n))
                      );
                    }
                  })(o, s, n, a),
                  ((e, t, n, o) => {
  ...
  const iy = (e, t, n) =>
    ...
    dy = (e, t, n = !1) =>
      iy(t, n, (t, n) => I.from(e.getByData(t, n)).orThunk(() => ry(n, t).map(n => ly(e, n, t)))),
    cy =
  ...
  var fC = (function e() {
     ...
     */ n.isSupported =
      'function' == typeof gy && 'function' == typeof C && x && void 0 !== x.createHTMLDocument;
    const {
      MUSTACHE_EXPR: A,
      ERB_EXPR: T,
      TMPLIT_EXPR: O,
    ...
    /* Parsing of strict XHTML documents */ let Se = null;
     ...
     */ const ze = function (e) {
        ...
        if (
          ...
          e.hasChildNodes() &&
            ...
            My(/<[/\w]/g, e.innerHTML) &&
            My(/<[/\w]/g, e.textContent))
        )
          return Pe(e), !0;
        /* Remove any occurrence of processing instructions */ if (7 === e.nodeType)
          return Pe(e), !0;
        ...
        /* Check whether element has a valid namespace */ return e instanceof d &&
          ...
          ('noscript' !== o && 'noembed' !== o && 'noframes' !== o) ||
            !My(/<\/no(script|embed|frames)/i, e.innerHTML)
          ? /* Sanitize element content to be template-safe */
            (G &&
              ...
              e.textContent !== t &&
                (Ny(n.removed, { element: e.cloneNode() }), (e.textContent = t))),
      ...
      je = function (e, t, n) {
        ...
        /* Allow valid data-* attributes: At least one character after "-"
          ...
          if (
            ...
            !(
              (He(e) &&
                ((H.tagNameCheck instanceof RegExp && My(H.tagNameCheck, e)) ||
                  (H.tagNameCheck instanceof Function && H.tagNameCheck(e))) &&
                ((H.attributeNameCheck instanceof RegExp && My(H.attributeNameCheck, t)) ||
                  (H.attributeNameCheck instanceof Function && H.attributeNameCheck(t)))) ||
              // Alternative, second condition checks if it's an `is`-attribute, AND
              // the value passes whatever the user has configured for CUSTOM_ELEMENT_HANDLING.tagNameCheck
              ('is' === t &&
                H.allowCustomizedBuiltInElements &&
                ((H.tagNameCheck instanceof RegExp && My(H.tagNameCheck, n)) ||
      ...
      Ve = function e(t) {
        ...
        /* Execute a hook if present */ for (
          Ue(R.beforeSanitizeShadowDOM, t, null);
          (n = o.nextNode());
      ...
      return (
        ...
        (!!/((java|vb)script|mhtml):/i.test(o) ||
          (!e.allow_html_data_urls &&
            (/^data:image\//i.test(o)
              ? ((e, t) => (C(e) ? !e : !C(t) || !H(vC, t)))(e.allow_svg_data_urls, n) &&
  ...
  const SC = (e, t, n, o, r) => {
    ...
    RC = (e, t, n, o) => {
      ...
      for (let s = r.length - 1; s >= 0; s--) {
        const a = r[s],
          i = a.name,
          l = a.value;
        _C(t, n, o, e.tagName.toLowerCase(), i, l) || kC(e, i)
          ? NC(i, n) && e.setAttribute(i, i)
          : e.removeAttribute(i);
      }
    },
    AC = (e, t, n) => {
      ...
      if ('svg' === n)
        ...
        ((e, t) => {
          ...
          n.addHook('uponSanitizeElement', (e, t) => {
            ...
            if ((r && 'semantics' === s && (t.allowedTags[s] = !0), 'annotation' === s)) {
              const n = e,
                a = (e => {
      ...
      const n = ty(),
        ...
        a = ((e, t) => {
          const n = (() => {
            ...
            return {
              track: n => (
                Ir(n) ? e.set(n) : e.get().exists(e => !e.contains(n)) && e.clear(), t()
              ),
              current: t,
              reset: () => {
                e.clear();
        ...
        p = {
          ...
          parse: (e, n = {}) => {
            ...
            Wr(t, c);
            const m = new tp(d, 11);
            PC(m, c, t.getSpecialElements(), a.sanitizeNamespaceElement), (c.innerHTML = '');
            const [f, p] = ((e, t, n, o) => {
                const r = n.validate,
                  s = t.getNonEmptyElements(),
                  a = t.getWhitespaceElements(),
            ...
            return (
              E &&
                ...
                ((e, n) => {
                  const o = BC(
                      OC('script,style,head,html,body,title,meta,param'),
                      t.getBlockElements()
                    ),
                    s = /^[ \t\r\n]+/,
                    a = /[ \t\r\n]+$/;
                  ...
                  if (t.isValidChild(e.name, n.toLowerCase())) {
                    for (; i; ) {
                      ...
                      g(o, i)
                        ? (l ||
                            ((l = new tp(n, 1)), l.attr(r.forced_root_block_attrs), e.insert(l, i)),
                          l.append(i))
                        : (d(l), (l = null)),
                        (i = t);
                    }
    ...
    LC = (e, t, n) => {
      ...
      if (jb(e)) {
        if (r.content !== o) {
          const t = DC({ validate: !1, forced_root_block: !1, ...n }).parse(r.content, {
            context: e.name,
          });
          return { ...r, content: t };
        }
    ...
    MC = e => ({ sanitize: Tc(e), sandbox_iframes: Mc(e), sandbox_iframes_exclusions: Ic(e) }),
    IC = (e, t) => {
      if (t.no_events) return Sl.value(t);
      {
        const n = ((e, t) => e.dispatch('BeforeGetContent', t))(e, t);
        return n.isDefaultPrevented()
          ? Sl.error(Il(e, { content: '', ...n }).content)
          : Sl.value(n);
      }
    },
    FC = (e, t, n) => {
    ...
    KC = (e, t) => {
      ...
      for (let e = 0; e < n.length; e++) {
        const o = n[e].cells;
        for (let n = 0; n < o.length; n++) if (_n(o[n], t)) return I.some($C(n, e));
      }
      return I.none();
    },
    YC = (e, t, n, o, r) => {
    ...
    lw = e => {
      const t = vn('body', rw());
      return ko(t, iw(e)), q(Uo(t, '*[data-mce-bogus]'), xo), _o(t);
    },
    dw = (e, t) =>
      !(!e || !t) && (!!((e, t) => iw(e) === iw(t))(e, t) || ((e, t) => lw(e) === lw(t))(e, t)),
    cw = e => 0 === e.get(),
    uw = (e, t, n) => {
      cw(n) && (e.typing = t);
    },
    mw = (e, t) => {
      e.typing && (uw(e, !1, t), e.add());
    },
    fw = e => ({
      init: { bindEvents: S },
      undoManager: {
        ...
        undo: (t, n, o) =>
          ((e, t, n, o) => {
            let r;
            return (
              t.typing && (t.add(), (t.typing = !1), uw(t, !1, n)),
              o.get() > 0 &&
                (o.set(o.get() - 1),
                (r = t.data[o.get()]),
                aw(e, r, !0),
        ...
        hasUndo: (t, n) =>
          ((e, t, n) => n.get() > 0 || (t.typing && t.data[0] && !dw(sw(e), t.data[0])))(e, t, n),
        hasRedo: (e, t) => ((e, t) => t.get() < e.data.length - 1 && !e.typing)(e, t),
        transact: (e, t, n) =>
          ((e, t, n) => (mw(e, t), e.beforeChange(), e.ignore(n), e.add()))(e, t, n),
        ignore: (e, t) =>
          ((e, t) => {
            try {
              e.set(e.get() + 1), t();
          ...
          ((e, t) => {
            ...
            return I.from(e.selection.getStart(!0))
              .bind(o =>
                Vb(
                  Cn(o),
                  n => ue(t, t => ((t, n) => (Xb(e, t.dom, n) ? I.some(n) : I.none()))(n, t)),
                  n
                )
              )
              .getOrNull();
      ...
      editor: {
        getContent: t =>
          ((e, t) =>
            I.from(e.getBody()).fold(N('tree' === t.format ? new tp('body', 11) : ''), n =>
              bp(e, t, n)
            ))(e, t),
        setContent: (t, n) =>
          ((e, t, n) =>
    ...
    vw = e => (0 === e.dom.length ? (Eo(e), I.none()) : I.some(e)),
    yw = (e, t, n, o, r) => {
      e.bind(
        e => (
        ...
        const e = ((e, t) => e.filter(e => yf.isBookmarkNode(e.dom)).bind(t ? Dn : Pn))(t, o)
          .or(t)
          .filter(Yt);
        return e.map(e =>
          ((e, t, n) => {
  ...
  const ww = e => !(!e || !e.ownerDocument) && kn(Cn(e.ownerDocument), Cn(e)),
      ...
      const { selectorChangedWithUnbind: a } = ((e, t) => {
        ...
        c = () => {
          ...
          try {
            ...
            e &&
              !Qo(e.anchorNode) &&
              ((n = e.rangeCount > 0 ? e.getRangeAt(0) : i.createRange()), (n = Xg(o, [n])[0]));
          } catch (e) {}
        ...
        u = (e, t) => {
          if (!(e => !!e && ww(e.startContainer) && ww(e.endContainer))(e)) return;
          const n = d();
        ...
        f = {
          ...
          serializer: n,
          editor: o,
          expand: (t = { type: 'word' }) => u(_g(e).expand(c(), t)),
          collapse: l,
          setCursorLocation: (t, n) => {
            const r = e.createRng();
            C(t) && C(n)
              ? (r.setStart(t, n), r.setEnd(t, n), u(r), l(!1))
              : (_m(e, r, o.getBody(), !0), u(r));
          },
          getContent: e =>
            ((e, t = {}) =>
              ((e, t, n) => hw(e).selection.getContent(t, n))(e, t.format ? t.format : 'html', t))(
              o,
              e
            ),
          setContent: i,
              ...
              I.from(t).bind(t =>
                I.from(t.parentNode).map(o => {
                  const r = e.nodeIndex(t),
                    s = e.createRng();
                  return (
                    s.setStart(o, r), s.setEnd(o, r + 1), n && (_m(e, s, t, !0), _m(e, s, t, !1)), s
                  );
                })
              ))(e, t, n).each(u),
            t
    ...
    kw = (e, t, n = {}) => {
      ...
      return UC(e, o)
        .map(t => {
          ...
          return zC(e, n.html, t), n.content;
        })
        .getOr(t);
    },
    Nw =
    ...
    cE = e => {
      e.parser.addAttributeFilter('contenteditable', t => {
        iE(e) &&
          q(t, e => {
            e.attr(lE, e.attr('contenteditable')), e.attr('contenteditable', 'false');
          });
      }),
      ...
      return {
        findAll: (o, r = M) => {
          const s = Y((e => (e ? ce(e.getElementsByTagName('img')) : []))(o), t => {
            ...
            a = V(s, e => {
              const o = e.src;
              if (Se(n, o)) return n[o].then(t => (m(t) ? t : { image: e, blobInfo: t.blobInfo }));
              {
                const r = ((e, t) => {
                    ...
                    return C(s)
                      ...
                      : ((o = t),
                        $e(o, 'blob:')
                          ...
                          sy(t).then(o => iy(o, !1, n => I.some(ly(e, t, n))).getOrThunk(n))
                        );
                  }
                  var o, r;
                  return $e(t, 'data:')
  ...
  const bE = (e, t) => {
    ...
    yE = (e, t) => bE(t, { url: md(e), basePath: fd(e), credentials: gd(e), handler: pd(e) }),
    CE = e => {
      const t = (() => {
        let e = [];
        const t = e => {
      ...
      const r = pE(),
        ...
        p = () => (
          ...
          o.findAll(e.getBody(), g).then(
            a(t => {
              const n = Y(t, t => (m(t) ? (Jw(e, t), !1) : 'blob' !== t.uriType));
              return (
                gw(e) ||
                  q(n, e => {
    ...
    EE = { selector: 'td,th', ...wE },
    xE = {
      tablecellbackgroundcolor: { styles: { backgroundColor: '%value' }, ...EE },
      tablecellverticalalign: { styles: { 'vertical-align': '%value' }, ...EE },
      tablecellbordercolor: { styles: { borderColor: '%value' }, ...EE },
      tablecellclass: { classes: ['%value'], ...EE },
      tableclass: { selector: 'table', classes: ['%value'], ...wE },
      tablecellborderstyle: { styles: { borderStyle: '%value' }, ...EE },
      tablecellborderwidth: { styles: { borderWidth: '%value' }, ...EE },
    },
    SE = N(xE),
    _E = Dt.each,
    kE = ma.DOM,
    ...
    TE = (e, t) => {
      ...
      var d;
      l.length > 0
        ? (l[0].name || (l[0].name = i), (i = t.selector), (a = RE(l, e)))
        : (a = RE([i], e));
      ...
      _E(t.styles, (e, t) => {
        ...
        kE.setStyles(a, { position: 'absolute', left: -65535 }),
    ...
    OE = e => {
      ...
      return (
          ...
          })(n, e),
        {
          ...
          match: (t, n, o, r) =>
            ((e, t, n, o, r) => hw(e).formatter.match(t, n, o, r))(e, t, n, o, r),
          closest: t => ((e, t) => hw(e).formatter.closest(t))(e, t),
          matchAll: (t, n) => ((e, t, n) => hw(e).formatter.matchAll(t, n))(e, t, n),
          matchNode: (t, n, o, r) =>
            ((e, t, n, o, r) => hw(e).formatter.matchNode(t, n, o, r))(e, t, n, o, r),
          canApply: t => ((e, t) => hw(e).formatter.canApply(t))(e, t),
          formatChanged: (t, o, r, s) =>
            ((e, t, n, o, r, s) => hw(e).formatter.formatChanged(t, n, o, r, s))(e, n, t, o, r, s),
          getCssText: T(TE, e),
        }
      );
    },
    ...
    PE = e => {
      const t = Dr(),
        ...
        r = {
          ...
          add: (s, a) =>
            ((e, t, n, o, r, s, a) => hw(e).undoManager.add(t, n, o, r, s, a))(e, r, o, n, t, s, a),
          dispatchChange: () => {
            e.setDirty(!0);
            const t = sw(e);
            ...
            e.on('init', () => {
              ...
              e.on('keydown', e => {
                ...
                if ((s < 16 || s > 20) && 224 !== s && 91 !== s && !t.typing && !a)
                  return t.beforeChange(), uw(t, !0, n), t.add({}, e), void o.set(!0);
    ...
    WE = (e, t, n, o) => (
      ...
      ((e, t) =>
        kn(t, e)
          ...
          : I.none())(t, n).fold(T(VE, e, t, n, o), T($E, e, t, n, o))
    ),
      ...
      t.collapsed
        ? ((e, t, n) => {
            const o = _u(1, e.getBody(), t),
              ...
              s = r.getNode();
            if (nu(s)) return QE(1, e, s, !r.isAtEnd(), !1);
            const a = r.getNode(!0);
            if (nu(a)) return QE(1, e, a, !1, !1);
    ...
    rx = (e, t) =>
      ((e, t) => {
        ...
        if (a(d)) return I.some(() => ox(e, n, i.getNode(), o, t, d));
        const c = s(d);
    ...
    ax = e => {
      ...
      return (
        !t.collapsed &&
        (sx(e, !0).exists(e => e.isEqual(el.fromRangeStart(t))) ||
          sx(e, !1).exists(e => e.isEqual(el.fromRangeEnd(t))))
      );
    },
    ix = _l([
      { remove: ['element'] },
          ...
          ((e, t, n, o, r) => {
            ...
            ? ((e, t, n, o, r) => {
                ...
                return zh(Cn(t), Cn(o.getNode()))
                  .map(t => (Tr(e, t) ? ix.remove(t.dom) : ix.moveToElement(s)))
                  .orThunk(() => I.some(ix.moveToElement(s)));
              })(o, e, t, n, r)
            : (t && zp(n)) || (!t && Up(n))
          ...
          () =>
            ((e, t, n, o) => {
              ...
              return !t && zp(s)
                ...
                : !t && Up(s) && eh(a, s, o)
                ? th(a, s, o).map(e => ix.remove(e.getNode()))
                : t && zp(s) && Jp(a, s, o)
                ? nh(a, s, o).map(e => ix.remove(e.getNode()))
                : ((e, t, n, o) =>
                    ((e, t) => {
                      const n = t.getNode(!e),
                        o = e ? 'after' : 'before';
                      ...
                      : lx(e, t, n, o).bind(t =>
                          ((e, t, n) =>
                            n.fold(
                              ...
                              n => (vu(t, n, e) ? I.none() : I.some(ix.moveToPosition(n)))
                            ))(e, n, t)
                        ))(e, t, s, o);
            })(e.getBody(), t, e.selection.getRng(), e.schema).map(
              n => () =>
                n.fold(
                  ((e, t) => n => (e._selectionOverrides.hideFakeCaret(), Rh(e, t, Cn(n)), !0))(
                    e,
                    t
                  ),
                  ((e, t) => n => {
      ...
      e
        ? (e => {
            ...
            if (yx(e.previousSibling))
              return wx(e.previousSibling) || e.previousSibling.appendData(ei), e.previousSibling;
            if (yx(e)) return Cx(e) || e.insertData(0, ei), e;
            {
              const n = Ex(e);
        ...
        : (e => {
            var t, n;
            if (yx(e.nextSibling))
              return Cx(e.nextSibling) || e.nextSibling.insertData(0, ei), e.nextSibling;
            if (yx(e)) return wx(e) || e.appendData(ei), e;
            {
              const o = Ex(e);
              return (
                e.nextSibling
    ...
    qx = (e, t) =>
      e.fold(M, e => {
        return (o = t), !(jx((n = e)) === jx(o) && zx(n) === zx(o));
        var n, o;
      }),
    Wx = (e, t) =>
      e
        ? t.fold(_(I.some, Tx.start), I.none, _(I.some, Tx.after), I.none)
        : t.fold(I.none, _(I.some, Tx.before), I.none, _(I.some, Tx.end)),
    Kx = (e, t, n) => {
      const o = e ? 1 : -1;
      return (
  ...
  const Gx = (e, t) => (-1 === e ? oe(t) : t),
    ...
    Qx = (e, t, n, o) => {
      ...
      for (; s; ) {
        ...
        if (gr(n.getNode(!1)))
          return 1 === t
            ? { positions: Gx(t, a).concat([n]), breakType: Yx.Br, breakAt: I.some(n) }
            : { positions: Gx(t, a), breakType: Yx.Br, breakAt: I.some(n) };
        if (n.isVisible()) {
          if (e(s, n)) {
            const e = Zx(0, t, s, n);
      ...
      return { positions: Gx(t, a), breakType: Yx.Eol, breakAt: I.none() };
    },
    Jx = (e, t, n, o) =>
      t(n, o)
        .breakAt.map(o => {
  ...
  const bS = (e, t, n, o, r, s) => {
    ...
    _S = (e, t, n, o, r, s) => {
      ...
      if (d(c)) return JE(e, c.getNode(!a));
      let u = l(c);
      const m = gi(n);
      if (!u) return m ? I.some(n) : I.none();
      if (((u = Ph(a, u)), d(u))) return QE(t, e, u.getNode(!a), a, !1);
      const f = l(u);
      return f && d(f) && Tu(u, f)
        ? QE(t, e, f.getNode(!a), a, !1)
        : m
        ? SS(e, u.toRange(), !1)
        : I.none();
    },
    kS = (e, t, n, o, r, s) => {
      ...
      if (((g = o(a) ? a.getNode() : r(a) ? a.getNode(!0) : Ei(n)), g)) {
        ...
        let o = fS(Y(n, ES(1)), m);
        if (o) return SS(e, o.position.toRange(), !1);
        if (((o = De(Y(n, ES(0)))), o)) return SS(e, o.position.toRange(), !1);
      }
      return 0 === u.length
        ? NS(e, l)
            .filter(l ? r : o)
            .map(t => ex(e, t.toRange(), !1))
        : I.none();
    },
    NS = (e, t) => {
      const n = e.selection.getRng(),
    ...
    OS = (e, t, n) => Rx(t, n).map(t => (AS(e, t), n)),
    BS = (e, t, n) => {
      const o = e.getBody(),
        r = ((e, t, n) => {
          ...
          .orThunk(() =>
            ((e, t, n, o, r) => {
              ...
              return qu(e, n, s)
                ...
                .fold(
                  () => o.map(Hx),
                  r => Ux(t, n, r).map(T(Vx, e, t, n, s, r)).filter(T(qx, o))
                )
                .filter(Fx);
            })(e, t, n, s, o)
          );
    ...
    DS = (e, t, n) =>
      ...
      ((e, t) => {
        ...
        return (
          ...
          (e && di(o) ? Kx(!0, t.selection, o) : !(e || !ci(o)) && Kx(!1, t.selection, o))
        );
      })(e, t),
    LS = e => {
      const t = Br(null),
          ...
          Md(e) &&
            (((e, t, n) => {
              const o = V(
                ...
                r = Y(o, e),
                s = Y(n, e);
              q(re(r, s), T(TS, !1)), q(re(s, r), T(TS, !0));
            })(n, e.dom, o.parents),
            ((e, t) => {
              const n = t.get();
    ...
    FS = (e, t, n) => {
      if (Md(e)) {
        ...
        return Ux(T(Th, e), e.getBody(), o).exists(t => {
          const o = Hx(t);
          return Rx(n, o).exists(t => (AS(e, t), !0));
        });
      }
      return !1;
    },
      ...
      if (e.selection.isCollapsed() && Md(e)) {
        ...
        return ((e, t, n, o) => {
          ...
          return a
            .bind(e =>
              n
                ? e.fold(N(I.some($x(e))), I.none, N(I.some(Hx(e))), I.none)
                : e.fold(I.none, N(I.some(Hx(e))), I.none, N(I.some($x(e))))
            )
            .map(US(e, t))
            .getOrThunk(() => {
              const i = Wu(n, r, o),
    ...
    ZS = e => (
      (e => {
        ...
        return (
          t.collapsed &&
          (YS(t) || e.dom.isEmpty(t.startContainer)) &&
          !(e => {
            return (
    ...
    i_ = e => {
      if (e.selection.isCollapsed() && n_(e)) {
        ...
        if (null !== r && Kp(Cn(r), o, e.schema)) return I.some(() => a_(e));
      }
      return I.none();
    },
    l_ = (e, t, n) =>
      ue([i_, mx, rx, (e, n) => jS(e, t, n), YE, hb, vx, JS, ZE, XS, bx], t => t(e, n)).filter(t =>
        e.selection.isEditable()
      ),
    d_ = e => (void 0 === e.touches || 1 !== e.touches.length ? I.none() : I.some(e.touches[0])),
    c_ = (e, t) => Se(e, t.nodeName),
    u_ = (e, t) =>
      !!lr(t) || (!!Jo(t) && !(c_(e.getBlockElements(), t) || fm(t) || Zr(e, t) || Ir(t))),
    m_ = (e, t) => {
      if (lr(t)) {
    ...
    v_ = (e, t) => {
      t.hasAttribute('data-mce-caret') &&
        (fi(t), e.selection.setRng(e.selection.getRng()), e.selection.scrollIntoView(t));
    },
    y_ = (e, t) => {
      const n = (e =>
      ...
      if (n)
        return 'compositionstart' === t.type
          ? (t.preventDefault(), t.stopPropagation(), void v_(e, n))
          : void (li(n) && (v_(e, n), e.undoManager.add()));
    },
    C_ = br,
    w_ = (e, t, n) => {
    ...
    E_ = (e, t) =>
      ((e, t) => {
        const n = t ? 1 : -1,
          o = e.selection.getRng();
        return ((e, t, n) => _S(t, e, n, Up, zp, C_))(n, e, o).orThunk(
          () => (w_(e, n, o), I.none())
        );
      })(
        e,
      ...
      ((e, t) => {
        ...
        return ((e, t, n) =>
          kS(
            ...
            e => zp(e) || Fp(e),
            C_
          ))(n, e, o).orThunk(() => (w_(e, n, o), I.none()));
      })(e, t).exists(t => (xS(e, t), !0)),
    ...
    B_ = (e, t) =>
      Q(
        ((e, t) => te((e => V(e, e => ({ ...A_, ...e })))(e), e => (T_(e, t) ? [e] : [])))(e, t),
        e => e.action()
      ),
    P_ = (e, t) =>
      ue(
    ...
    D_ = (e, t) => {
      const n = t ? 1 : -1,
        o = e.selection.getRng();
      return _S(e, n, o, Lp, Mp, wr).exists(t => (xS(e, t), !0));
    },
    L_ = (e, t) => {
      const n = t ? 1 : -1,
        o = e.selection.getRng();
      return kS(e, n, o, Lp, Mp, wr).exists(t => (xS(e, t), !0));
    },
    ...
    F_ = { ...I_, none: e => I_.none(e) },
    U_ = (e, t, n) => te(In(e), e => (xn(e, t) ? (n(e) ? [e] : []) : U_(e, t, n))),
    z_ = (e, t) => to(e, 'table', t),
    j_ = (e, t, n, o, r = M) => {
      const s = 1 === o;
      if (!s && n <= 0) return F_.first(e[0]);
      if (s && n >= e.length - 1) return F_.last(e[e.length - 1]);
      {
        const s = n + o,
          a = e[s];
    ...
    Y_ = (e, t, n) => {
      const o = e(t, n);
      return (e => e.breakType === Yx.Wrap && 0 === e.positions.length)(o) ||
        (!gr(n.getNode()) && (e => e.breakType === Yx.Br && 1 === e.positions.length)(o))
    ...
    J_ = (e, t, n, o) => {
      ...
      if (!t && G_(o, s)) {
        const o = ((e, t, n) =>
          ((e, t) =>
            le(t.getClientRects())
              .bind(t => W_(e, t.left, t.top))
              .bind(e => {
                return tS(
                  Qu((n = e))
                    .map(e => nS(n, e).positions.concat(e))
                    .getOr([]),
                  t
                );
                var n;
              }))(t, n)
            .orThunk(() => le(n.getClientRects()).bind(n => eS(rS(e, el.before(t)), n.left)))
          ...
          ((e, t) =>
            de(t.getClientRects())
              ...
              .bind(e => {
                return tS(
                  Zu((n = e))
                    .map(e => [e].concat(oS(n, e).positions))
                    .getOr([]),
                  t
                );
                var n;
              }))(t, n)
            .orThunk(() => le(n.getClientRects()).bind(n => eS(sS(e, el.after(t)), n.left)))
    ...
    ok = (e, t, n) =>
      n.fold(
        ...
        n =>
          e.mode.isReadOnly() || !rk(n)
            ? I.none()
            : (e.execCommand('mceTableInsertRowAfter'), sk(e, t, n))
      ),
    rk = e => Zn(e, Zt('table')).exists(no),
    sk = (e, t, n) => {
      return ok(
        e,
        t,
      ...
      return ((e, t) =>
        ((e, t, n = L) =>
          n(t)
            ...
            : H(e, $t(t))
            ? I.some(t)
            : Jn(t, e.join(','), e => xn(e, 'table') || n(e)))(['td', 'th'], e, t))(
    ...
    ck = (e, t) => ({ container: e, offset: t }),
    uk = ma.DOM,
    mk = e => t => e === t ? -1 : 0,
    fk = (e, t, n) => {
      if (lr(e) && t >= 0) return I.some(ck(e, t));
      {
        const o = za(uk);
        return I.from(o.backwards(e, t, mk(e), n)).map(e =>
          ck(e.container, e.container.data.length)
        );
      }
    },
    gk = (e, t, n) => {
      ...
      const o = e.data;
      if (t >= 0 && t <= o.length) return I.some(ck(e, t));
      {
        const o = za(uk);
        return I.from(o.backwards(e, t, mk(e), n)).bind(e => {
          const o = e.container.data;
          return gk(e.container, t + o.length, n);
        });
      }
    },
    pk = (e, t, n) => {
      if (!lr(e)) return I.none();
      const o = e.data;
      if (t <= o.length) return I.some(ck(e, t));
      {
        const r = za(uk);
    ...
    yk = (e, t, n, o = !1) => {
      ...
      return hk(
        ...
        return 0 !== r.lastIndexOf(n) ? I.none() : I.some({ text: vk(r, n), range: o, trigger: n });
      });
    },
    Ck = e => {
      if ((e => 3 === e.nodeType)(e)) return ck(e, e.data.length);
      {
        ...
        i = Y(
          ...
          t =>
            ...
            t.matches.getOrThunk(() =>
              (e => t => {
                const n = wk(t.startContainer, t.startOffset);
                return !((e, t) => {
                  var n;
                  const o =
                    null !== (n = e.getParent(t.container, e.isBlock)) && void 0 !== n
                      ? n
                      : e.getRoot();
                  return hk(e, t.container, t.offset, (e, t) => (0 === t ? -1 : t), o)
                    .filter(e => {
  ...
  const Sk = (e, t, n) => (e.stype === xk.Error ? t(e.serror) : n(e.svalue)),
    _k = e => ({ stype: xk.Value, svalue: e }),
    kk = e => ({ stype: xk.Error, serror: e }),
    Nk = Sk,
    Rk = e => (f(e) && fe(e).length > 100 ? ' removed due to size' : JSON.stringify(e, null, 2)),
    Ak = (e, t) => kk([{ path: e, getErrorInfo: t }]),
    Tk = (e, t) => ({
      extract: (n, o) =>
        xe(o, e).fold(
          () =>
            ((e, t) => Ak(e, () => 'Choice schema did not contain choice key: "' + t + '"'))(n, e),
          e =>
            ((e, t, n, o) =>
              xe(n, o).fold(
                () =>
                  ((e, t, n) =>
                    Ak(
                      e,
                      () => 'The chosen schema: "' + n + '" did not exist in branches: ' + Rk(t)
                    ))(e, n, o),
    ...
    Bk = Ok((e, t) => (g(e) && g(t) ? Bk(e, t) : t)),
    Pk = Ok((e, t) => t),
    Dk = e => ({ tag: 'defaultedThunk', process: N(e) }),
    Lk = e => {
      const t = (e => {
        const t = [],
          n = [];
      ...
      return t.errors.length > 0 ? ((n = t.errors), _(kk, ee)(n)) : _k(t.values);
      var n;
    },
    Mk = (e, t, n) => {
      switch (e.tag) {
    ...
    Ik = e => ({
      extract: (t, n) => {
        return (
          (o = e(n)),
          (r = e => ((e, t) => Ak(e, N(t)))(t, e)),
          o.stype === xk.Error ? r(o.serror) : o
        );
        var o, r;
      },
      toString: N('val'),
    ...
    Fk = Ik(_k),
    Uk = (e, t, n, o) => o(xe(e, t).getOrThunk(() => n(e))),
    zk = (e, t, n, o, r) => {
          ...
          e.fold(
            ...
            e => {
              ...
              return (
                (s = n),
                (a = I.some),
                s.stype === xk.Value ? { stype: xk.Value, svalue: a(s.svalue) } : s
              );
              var s, a;
            }
          );
        ...
        case 'required':
          return ((e, t, n, o) =>
            xe(t, n).fold(
              () =>
                ((e, t, n) =>
                  Ak(e, () => 'Could not find valid *required* value for "' + t + '" in ' + Rk(n)))(
                  e,
                  n,
                  t
                ),
    ...
    Vk = (e, t, n) => {
      return (
        (o = ((e, t, n) =>
          ((e, t) => (e.stype === xk.Error ? { stype: xk.Error, serror: t(e.serror) } : e))(
            t.extract([e], n),
            e => ({ input: n, errors: e })
          ))(e, t, n)),
        Sk(o, Sl.error, Sl.value)
      );
      var o;
    },
    qk = (e, t) => Tk(e, he(t, jk)),
    ...
    Kk = (e, t) =>
      Ik(n => {
        const o = typeof n;
        return e(n) ? _k(n) : kk(`Expected type: ${t} but got: ${o}`);
      }),
    Yk = Kk(E, 'number'),
    Gk = Kk(m, 'string'),
    Xk = Kk(b, 'boolean'),
    Zk = Kk(w, 'function'),
    Qk = (e, t, n, o) => ({ tag: 'field', key: e, newKey: t, presence: n, prop: o }),
    Jk = (e, t) => ({ tag: 'custom', newKey: e, instantiator: t }),
    eN = e => {
      return (
        (t = t =>
          H(e, t)
    ...
    tN = (e, t) => Qk(e, e, { tag: 'required', process: {} }, t),
    nN = e => tN(e, Gk),
    oN = (e, t) => Qk(e, e, { tag: 'required', process: {} }, eN(t)),
    rN = e => tN(e, Zk),
    sN = (e, t) => Qk(e, e, { tag: 'required', process: {} }, Hk(t)),
    aN = (e, t) => Qk(e, e, { tag: 'option', process: {} }, t),
    iN = e => aN(e, Gk),
    lN = (e, t, n) => Qk(e, e, Dk(t), n),
    dN = (e, t) => lN(e, t, Yk),
    cN = (e, t) => lN(e, t, Gk),
    uN = (e, t, n) => lN(e, t, eN(n)),
    mN = (e, t) => lN(e, t, Xk),
    fN = (e, t) => lN(e, t, Zk),
    gN = nN('type'),
    pN = rN('fetch'),
    ...
    kN = jk([
      ...
      nN('trigger'),
      dN('minChars', 1),
      (e => Qk(e, e, Dk(1), Wk()))('columns'),
      dN('maxResults', 10),
      aN('matches', Zk),
      pN,
      hN,
      ((NN = Gk), lN('highlightOn', [], Hk(NN))),
    ]);
  var NN;
  const RN = [xN, CN, yN, vN, bN, cN('context', 'mode:design')],
    AN = [EN].concat(RN),
    TN = [
      fN('predicate', L),
      uN('scope', 'node', ['node', 'editor']),
      uN('position', 'selection', ['node', 'selection', 'line']),
    ],
    ON = RN.concat([_N('contextformbutton'), cN('align', 'end'), SN, hN, Jk('original', R)]),
    BN = AN.concat([_N('contextformbutton'), cN('align', 'end'), SN, hN, Jk('original', R)]),
    PN = RN.concat([_N('contextformbutton')]),
    DN = AN.concat([_N('contextformtogglebutton')]),
    LN = [
      wN,
      sN('commands', qk('type', { contextformbutton: ON, contextformtogglebutton: BN })),
      aN('launch', qk('type', { contextformbutton: PN, contextformtogglebutton: DN })),
      fN('onInput', S),
      fN('onSetup', S),
    ];
  qk('type', {
    ...
    contextsizeinputform: [
      ...TN,
      ...LN,
      oN('type', ['contextsizeinputform']),
      fN('initValue', N({ width: '', height: '' })),
    ],
  }),
    jk(
      [
        ...
        tN(
            ...
            return {
              extract: (n, o) => {
                ...
                for (const s of e) {
                  ...
                  if (e.stype === xk.Value) return { stype: xk.Value, svalue: t(e.svalue) };
                  r.push(e);
                }
                return Lk(r);
              },
          ...
          })([Gk, $k([iN('name'), iN('label'), sN('items', Gk)])])
        ),
      ].concat(TN)
    );
  const MN = e => {
      const t = e.ui.registry.getAll().popups,
        n = he(t, e => {
          return ((t = e), Vk('Autocompleter', kN, t)).fold(e => {
            throw new Error(
              'Errors: \n' +
                (e => {
                  const t =
      ...
      const t = Dr(),
        ...
        a = a => {
          (n =>
            t
              .get()
              .map(t => yk(e.dom, e.selection.getRng(), t.trigger, !0).bind(t => Ek(e, s, t, n)))
              .getOrThunk(() =>
                ((e, t) => {
                  const n = t(),
                    o = e.selection.getRng();
                  return ((e, t, n) => ue(n.triggers, n => yk(e, t, n)))(e.dom, o, n).bind(n =>
                    Ek(e, t, n)
                  );
                })(e, s)
              ))(a).fold(r, r => {
    ...
    jN = (e, t) => I.from(e.getParent(t.container(), 'details')),
    HN = (e, t) => jN(e, t).isSome(),
    $N = (e, t) => {
      const n = t.getNode();
    ...
    qN = (e, t, n) => {
      ...
      if ('character' === n) {
        ...
        return (
          !!(l && (t ? c : d) && Wu(!t, s, n).exists(e => HN(o, e) && !Mt(i, jN(o, e)))) ||
          Wu(t, s, n).fold(L, n => {
            const r = jN(o, n);
            if (HN(o, n) && !Mt(i, r)) {
              if ((t || VN(e, n, !1), a && l)) {
      ...
      return 'selection' === o
        ...
        ? ((e, t) =>
            t.startSummary.exists(t =>
              ((e, t) =>
                Qu(t).exists(
                  n => (gr(n.getNode()) && Xu(t, n).exists(t => t.isEqual(e))) || n.isEqual(e)
                ))(e, t)
            ))(s, t) ||
          ((e, t, n) =>
            n.startDetails.exists(n => Gu(e, t).forall(e => !n.contains(e.container()))))(a, s, t)
        : ((e, t) => t.startSummary.exists(t => ((e, t) => Zu(t).exists(t => t.isEqual(e)))(e, t)))(
            s,
            t
          ) ||
          ((e, t) =>
    ...
    ZN = xt(),
    QN = ZN.os,
    JN = QN.isMacOS() || QN.isiOS(),
    eR = ZN.browser.isFirefox(),
    tR = (e, t) => {
      const n = e.dom,
    ...
    oR = e => I.from(e.dom.getParent(e.selection.getStart(!0), e.dom.isBlock)),
    rR = e => {
    ...
    aR = (e, t, n, o, r = !0, s, a) => {
      ...
      return sR(e, f), rR(g), f;
    },
    iR = (e, t) => {
      const n = null == e ? void 0 : e.parentNode;
      return C(n) && n.nodeName === t;
    },
    lR = e => C(e) && /^(OL|UL|LI)$/.test(e.nodeName),
    dR = e => C(e) && /^(LI|DT|DD)$/.test(e.nodeName),
    cR = e => {
      const t = e.parentNode;
      return dR(t) ? t : e;
    },
    ...
    fR = (e, t) => t && 'A' === t.nodeName && e.isEmpty(t),
    gR = (e, t) => e.nodeName === t || (e.previousSibling && e.previousSibling.nodeName === t),
    pR = (e, t) =>
      C(t) &&
      e.isBlock(t) &&
      ...
      insert: (e, t) => {
        ...
        const i = e.dom,
          ...
          v = e => {
            ...
            let s;
            for (
              lr(n) && (e && 0 === t ? r.prev() : e || t !== n.data.length || r.next());
              (s = r.current());
        ...
        E ||
          (n = ((e, t, n, o, r) => {
            var s, a;
            const i = e.dom,
              l = null !== (s = nR(i, o)) && void 0 !== s ? s : i.getRoot();
        ...
        if (/^(LI|DT|DD)$/.test(r) && Jo(s) && i.isEmpty(_))
          return void ((e, t, n, o, r) => {
            ...
            var l;
            lR((l = n)) && lR(l.parentNode) && (r = 'LI');
            const d = dR(o) ? mR(o) : void 0;
            let c = dR(o) && d ? t(r, { style: mR(o) }) : t(r);
            if (uR(n, o, !0) && uR(n, o, !1))
              if (iR(n, 'LI')) {
                const e = cR(n);
                s.insertAfter(c, e),
                  (e => {
              ...
              iR(n, 'LI')
                ...
                : i.insertBefore(c, n),
                s.remove(o);
            else if (uR(n, o, !1)) s.insertAfter(c, cR(n)), s.remove(o);
            else {
              n = cR(n);
        ...
        if (!(p || (_ !== e.getBody() && pR(i, _)))) return;
        ...
        if (p)
        ...
        else if (si(_)) (R = fi(_)), i.isEmpty(_) && rR(_), sR(e, R), tR(e, R);
        else if (v(!1)) R = w();
        else if (v(!0) && N) {
          ...
          const t = (e => {
            const t = e.cloneRange();
            return (
              t.setStart(e.startContainer, hR(!0, e.startContainer, e.startOffset)),
              t.setEnd(e.endContainer, hR(!1, e.endContainer, e.endOffset)),
              t
            );
          })(d).cloneRange();
          t.setEndAfter(_);
          ...
          (e => {
            ...
            i.isEmpty(_) && rR(_),
            R.normalize(),
            i.isEmpty(R) ? (i.remove(R), w()) : (sR(e, R), tR(e, R));
        }
    ...
    CR = (e, t) => {
      wR(e.getBody(), t) || ho(Cn(t), vn('br'));
      const n = vn('br');
      ho(Cn(t), n), vR(e, n.dom, !1), e.undoManager.add();
    },
    wR = (e, t) => {
      return (
        (n = el.after(t)),
    ...
    ER = e => e && 'A' === e.nodeName && 'href' in e,
    xR = e => e.fold(L, ER, ER, L),
    SR = (e, t) => {
      t.fold(S, T(yR, e), T(CR, e), S);
    },
    _R = {
      insert: (e, t) => {
        const n = (e => {
          ...
          return Ux(t, e.getBody(), n).filter(xR);
        })(e);
        n.isSome()
          ? n.each(T(SR, e))
          : ((e, t) => {
    ...
    AR = e => (t, n) =>
      (e =>
        oR(e)
          ...
          .isSome())(t) === e,
    TR = (e, t) => (n, o) => {
      const r = (e => oR(e).fold(N(''), e => e.nodeName.toUpperCase()))(n) === e.toUpperCase();
      return r === t;
    },
    OR = e => {
      const t = nR(e.dom, e.selection.getStart());
      return y(t);
    },
    BR = e => TR('pre', e),
    PR = e => (t, n) => Jl(t) === e,
    DR = (e, t) => (e => kR(e, od(e)))(e),
    LR = (e, t) => t,
    MR = e => {
      const t = ed(e),
        n = nR(e.dom, e.selection.getStart());
    ...
    UR = (e, t, n) => {
      if (!t.mode.isReadOnly()) {
        if (
          ...
          C(n) && XN(t, e.fakeEventName).isDefaultPrevented())
        )
          return;
        ...
        r = ((e, t) =>
          Ax(
            [
              FR([RR], NR.none()),
              FR([BR(!0), OR], NR.none()),
              FR([TR('summary', !0)], NR.br()),
              FR([BR(!0), PR(!1), LR], NR.br()),
              FR([BR(!0), PR(!1)], NR.block()),
              FR([BR(!0), PR(!0), LR], NR.block()),
              FR([BR(!0), PR(!0)], NR.br()),
              FR([AR(!0), LR], NR.br()),
              FR([AR(!0)], NR.block()),
              FR([DR], NR.br()),
    ...
    jR = xt(),
    HR = jR.os.isiOS() && jR.browser.isSafari(),
    $R = (e, t) => {
      var n;
    ...
    VR = xt(),
    qR = e => e.stopImmediatePropagation(),
    WR = e => e.keyCode === Qf.PAGE_UP || e.keyCode === Qf.PAGE_DOWN,
    KR = (e, t, n) => {
      n && !e.get() ? t.on('NodeChange', qR, !0) : !n && e.get() && t.off('NodeChange', qR),
        e.set(n);
    },
    YR = (e, t) => e === t || e.contains(t),
    GR = (e, t) => {
      const n = t.container(),
        o = t.offset();
      return lr(n)
    ...
    tA = e =>
      Pc(e)
        ? [
            { keyCode: Qf.TAB, action: O_(dk, e, !0) },
            { keyCode: Qf.TAB, shiftKey: !0, action: O_(dk, e, !1) },
          ]
        : [],
    nA = e => {
      if ((e.addShortcut('Meta+P', '', 'mcePrint'), IN(e), gw(e))) return Br(null);
      {
        const t = LS(e);
        return (
          (e => {
            e.on('beforeinput', t => {
              (e.selection.isEditable() &&
                !$(
                  ...
                  t =>
                    !((e, t) =>
                      !YR(e.getBody(), t.startContainer) ||
                      !YR(e.getBody(), t.endContainer) ||
                      qg(e.dom, t))(e, t)
                )) ||
                t.preventDefault();
            });
            ...
            e.on('keydown', n => {
              n.isDefaultPrevented() ||
                ((e, t, n) => {
                  ...
                  B_(
                    [
                      { keyCode: Qf.RIGHT, action: O_(E_, e, !0) },
                      { keyCode: Qf.LEFT, action: O_(E_, e, !1) },
                      { keyCode: Qf.UP, action: O_(x_, e, !1) },
                      { keyCode: Qf.DOWN, action: O_(x_, e, !0) },
                      ...(o
                        ? [
                            { keyCode: Qf.UP, action: O_(__, e, !1), metaKey: !0, shiftKey: !0 },
                            { keyCode: Qf.DOWN, action: O_(__, e, !0), metaKey: !0, shiftKey: !0 },
                          ]
                        : []),
                      { keyCode: Qf.RIGHT, action: O_(tk, e, !0) },
                      { keyCode: Qf.LEFT, action: O_(tk, e, !1) },
                      { keyCode: Qf.UP, action: O_(nk, e, !1) },
                      { keyCode: Qf.DOWN, action: O_(nk, e, !0) },
                      { keyCode: Qf.UP, action: O_(nk, e, !1) },
                      { keyCode: Qf.UP, action: O_(R_, e, !1) },
                      { keyCode: Qf.DOWN, action: O_(R_, e, !0) },
                      { keyCode: Qf.RIGHT, action: O_(D_, e, !0) },
                      { keyCode: Qf.LEFT, action: O_(D_, e, !1) },
                      { keyCode: Qf.UP, action: O_(L_, e, !1) },
                      { keyCode: Qf.DOWN, action: O_(L_, e, !0) },
                      { keyCode: Qf.RIGHT, action: O_(PS, e, t, !0) },
                      { keyCode: Qf.LEFT, action: O_(PS, e, t, !1) },
                      { keyCode: Qf.RIGHT, ctrlKey: !o, altKey: o, action: O_(MS, e, t) },
                      { keyCode: Qf.LEFT, ctrlKey: !o, altKey: o, action: O_(IS, e, t) },
                      { keyCode: Qf.UP, action: O_(N_, e, !1) },
                      { keyCode: Qf.DOWN, action: O_(N_, e, !0) },
                    ],
                    n
                  ).each(e => {
                    n.preventDefault();
              ...
              (n = o.keyCode === Qf.BACKSPACE),
                o.isDefaultPrevented() ||
                  ((e, t, n) => {
                    ...
                    P_(
                      [
                        { keyCode: Qf.BACKSPACE, action: O_(i_, e) },
                        { keyCode: Qf.BACKSPACE, action: O_(mx, e, !1) },
                        { keyCode: Qf.DELETE, action: O_(mx, e, !0) },
                        { keyCode: Qf.BACKSPACE, action: O_(rx, e, !1) },
                        { keyCode: Qf.DELETE, action: O_(rx, e, !0) },
                        { keyCode: Qf.BACKSPACE, action: O_(jS, e, t, !1) },
                        { keyCode: Qf.DELETE, action: O_(jS, e, t, !0) },
                        { keyCode: Qf.BACKSPACE, action: O_(hb, e, !1) },
                        { keyCode: Qf.DELETE, action: O_(hb, e, !0) },
                        { keyCode: Qf.BACKSPACE, action: O_(KN, e, !1, s) },
                        { keyCode: Qf.DELETE, action: O_(KN, e, !0, s) },
                        ...(JN
                          ? [
                              { keyCode: Qf.BACKSPACE, altKey: !0, action: O_(KN, e, !1, a(!0)) },
                              { keyCode: Qf.DELETE, altKey: !0, action: O_(KN, e, !0, a(!0)) },
                              { keyCode: Qf.BACKSPACE, metaKey: !0, action: O_(KN, e, !1, a(!1)) },
                            ]
                          : [
                              { keyCode: Qf.BACKSPACE, ctrlKey: !0, action: O_(KN, e, !1, a(!0)) },
                              { keyCode: Qf.DELETE, ctrlKey: !0, action: O_(KN, e, !0, a(!0)) },
                            ]),
                        { keyCode: Qf.BACKSPACE, action: O_(vx, e, !1) },
                        { keyCode: Qf.DELETE, action: O_(vx, e, !0) },
                        { keyCode: Qf.BACKSPACE, action: O_(JS, e, !1) },
                        { keyCode: Qf.DELETE, action: O_(JS, e, !0) },
                        { keyCode: Qf.BACKSPACE, action: O_(ZE, e, !1) },
                        { keyCode: Qf.DELETE, action: O_(ZE, e, !0) },
                        { keyCode: Qf.BACKSPACE, action: O_(YE, e, !1) },
                        { keyCode: Qf.DELETE, action: O_(YE, e, !0) },
                        { keyCode: Qf.BACKSPACE, action: O_(XS, e, !1) },
                        { keyCode: Qf.DELETE, action: O_(XS, e, !0) },
                        { keyCode: Qf.BACKSPACE, action: O_(bx, e, !1) },
                        { keyCode: Qf.DELETE, action: O_(bx, e, !0) },
                      ],
                      n
                    )
                      .filter(t => e.selection.isEditable())
                      .each(t => {
                        n.preventDefault(), XN(e, o).isDefaultPrevented() || (t(), GN(e, o));
                      });
                  })(e, t, o);
            }),
              e.on('keyup', t => {
                t.isDefaultPrevented() ||
                  ((e, t, n) => {
                    B_(
                      [
                        { keyCode: Qf.BACKSPACE, action: O_(ux, e) },
                        { keyCode: Qf.DELETE, action: O_(ux, e) },
                        ...(JN
                          ? [
                              { keyCode: Qf.BACKSPACE, altKey: !0, action: O_(ZS, e) },
                              { keyCode: Qf.DELETE, altKey: !0, action: O_(ZS, e) },
                              ...(n ? [{ keyCode: eR ? 224 : 91, action: O_(ZS, e) }] : []),
                            ]
                          : [
                              { keyCode: Qf.BACKSPACE, ctrlKey: !0, action: O_(ZS, e) },
                              { keyCode: Qf.DELETE, ctrlKey: !0, action: O_(ZS, e) },
                            ]),
                      ],
                      t
                    );
            ...
            e.on('keydown', t => {
              t.isDefaultPrevented() ||
                ((e, t) => {
                  P_(
                    [
                      { keyCode: Qf.SPACEBAR, action: O_(JR, e) },
                      { keyCode: Qf.SPACEBAR, action: O_(eA, e) },
                    ],
                    t
                  ).each(n => {
                    t.preventDefault(),
                      XN(e, 'insertText', { data: ' ' }).isDefaultPrevented() ||
                        (n(), GN(e, 'insertText', { data: ' ' }));
                  });
                })(e, t);
            });
          })(e),
            ...
            e.on('keydown', n => {
              n.isDefaultPrevented() ||
                ((e, t, n) => {
                  ...
                  B_(
                    [
                      { keyCode: Qf.END, action: O_(S_, e, !0) },
                      { keyCode: Qf.HOME, action: O_(S_, e, !1) },
                      ...(o
                        ? []
                        : [
                            { keyCode: Qf.HOME, action: O_(__, e, !1), ctrlKey: !0, shiftKey: !0 },
                            { keyCode: Qf.END, action: O_(__, e, !0), ctrlKey: !0, shiftKey: !0 },
                          ]),
                      { keyCode: Qf.END, action: O_(M_, e, !0) },
                      { keyCode: Qf.HOME, action: O_(M_, e, !1) },
                      { keyCode: Qf.END, action: O_(FS, e, !0, t) },
                      { keyCode: Qf.HOME, action: O_(FS, e, !1, t) },
                    ],
                    n
                  ).each(e => {
                    n.preventDefault();
              ...
              e.on('keyup', o => {
                o.isDefaultPrevented() ||
                  ((e, t, n) => {
                    B_(
                      [
                        { keyCode: Qf.PAGE_UP, action: O_(FS, e, !1, t) },
                        { keyCode: Qf.PAGE_DOWN, action: O_(FS, e, !0, t) },
                      ],
                      n
                    );
                  })(e, t, o),
                  WR(o) && n.get() && (KR(n, e, !1), e.nodeChanged());
              });
          })(e, t),
          t
        );
  ...
  const rA = La('image'),
    ...
    cA = e => {
      const t = e;
      return I.from(t[sA]).exists(e => 0 === e);
    };
  const uA = La('mode'),
    mA = e => t => {
      t[uA] = e;
    ...
    bA = e => t => {
      const n = t;
      return I.from(n[uA]).exists(t => t === e);
    },
    vA = bA(0),
    yA = bA(1),
    CA = ['none', 'copy', 'link', 'move'],
    wA = [
      'none',
      'copy',
      'copyLink',
    ...
    EA = () => {
      ...
      const o = {
        ...
        get files() {
          return yA(o) ? Object.freeze({ length: 0, item: e => null }) : e.files;
        },
        get types() {
          return e.types;
        },
        setDragImage: (t, n, r) => {
          var s;
          vA(o) && ((s = { image: t, x: n, y: r }), (o[rA] = s), e.setDragImage(t, n, r));
        },
        getData: t => (yA(o) ? '' : e.getData(t)),
        setData: (t, n) => {
          vA(o) && e.setData(t, n);
        },
        clearData: t => {
    ...
    RA = e => -1 !== e.indexOf(kA),
    AA = '%MCEPASTEBIN%',
    TA = e => e.dom.get('mcepastebin'),
    OA = e => C(e) && 'mcepastebin' === e.id,
    BA = e => e === AA,
    PA = (e, t) => (
      Dt.each(t, t => {
    ...
    MA = (e, t) => (e.insertContent(t, { merge: vc(e), paste: !0 }), !0),
    IA = e => /^https?:\/\/[\w\-\/+=.,!;:&%@^~(){}?#]+$/i.test(e),
    FA = (e, t, n) =>
      !(e.selection.isCollapsed() || !IA(t)) &&
      ((e, t, n) => (
        e.undoManager.extra(
          () => {
            n(e, t);
    ...
    UA = (e, t, n) =>
      !!((e, t) => IA(t) && $(Bc(e), e => Ve(t.toLowerCase(), `.${e.toLowerCase()}`)))(e, t) &&
      ((e, t, n) => (
        e.undoManager.extra(
          () => {
            n(e, t);
          ...
          n = () =>
            ((e, t, n) => {
              n || !yc(e)
                ? MA(e, t)
                : ((e, t) => {
                    Dt.each([FA, UA, MA], n => !n(e, t, MA));
                  })(e, t);
            })(e, t, o);
        r
          ? XN(e, 'insertFromPaste', { dataTransfer: jA(t) }).isDefaultPrevented() ||
            (n(), GN(e, 'insertFromPaste'))
          : n();
      }
    },
    $A = (e, t, n, o) => {
      const r = n || RA(t);
      HA(e, (e => e.replace(kA, ''))(t), r, !1, o);
    },
    VA = (e, t, n) => {
    ...
    KA = e => WA(e, 'text/html') || WA(e, 'text/plain'),
    YA = (e, t, n) => {
          ...
          (s =
            WA(t, 'text/plain') && i
              ...
              : (e => {
                  ...
                  return (e = PA(e, [/<!\[[^\]]+\]>/g])), i(n.parse(e)), o;
                })(s)),
        BA(s) || (o ? VA(e, s, r) : $A(e, s, a, r));
    },
    XA = (e, t, n) => {
      ((e, t, n) => {
        let o;
        e.on('keydown', e => {
          (e => (Qf.metaKeyPressed(e) && 86 === e.keyCode) || (e.shiftKey && 45 === e.keyCode))(
            e
          ) &&
            !e.isDefaultPrevented() &&
          ...
          e.on('paste', r => {
            ...
            o = !1;
            const a = qA(r.clipboardData);
            (!KA(a) && YA(e, r, t.getLastRng() || e.selection.getRng())) ||
              (WA(a, 'text/html')
                ? (r.preventDefault(), GA(e, a, a['text/html'], s, !0))
                : WA(a, 'text/plain') && WA(a, 'text/uri-list')
                ? (r.preventDefault(), GA(e, a, a['text/plain'], s, !0))
                : (t.create(),
                  Uf.setEditorTimeout(
                    e,
                    () => {
                      const n = t.getHtml();
                      t.remove(), GA(e, a, n, s, !1);
                    },
                    0
                  )));
          });
    ...
    tT = (e, t) => {
      var n, o;
      return _g.getCaretRangeFromPoint(
    ...
    oT = /rgb\s*\(\s*([0-9]+)\s*,\s*([0-9]+)\s*,\s*([0-9]+)\s*\)/gi,
    rT = e => Dt.trim(e).replace(oT, Ws).toLowerCase(),
    sT = (e, t, n) => {
      const o = hc(e);
            ...
            remove: () =>
              ((e, t) => {
                ...
                if (TA(e)) {
                  let o;
                  const r = t.get();
                  for (; (o = TA(e)); ) n.remove(o), n.unbind(o);
      ...
      (e => {
        ...
        ((e, t) => {
          e.addCommand('mceTogglePlainTextPaste', () => {
            ((e, t) => {
              'text' === t.get() ? (t.set('html'), Ul(e, !1)) : (t.set('text'), Ul(e, !0)),
                e.focus();
            })(e, t);
          }),
            e.addCommand('mceInsertClipboardContent', (t, n) => {
              n.html && $A(e, n.html, n.internal, !1), n.text && VA(e, n.text, !1);
            });
        })(e, n),
        (e => {
          const t = t => n => {
          ...
          (e => {
            e.on(
              ...
              e.on(
                'copy',
                (e => t => {
                  !t.isDefaultPrevented() && eT(e) && ZA(t, JA(e), QA(e), S);
                })(e)
              );
          })(e),
            ((e, t) => {
              uc(e) &&
                ...
                e.on('drop', n => {
                  ...
                  (d && !l) ||
                    (i &&
                      ...
                      Uf.setEditorTimeout(e, () => {
                        e.undoManager.transact(() => {
                          (a || (d && l)) && e.execCommand('Delete'), nT(e, o);
                          const t = DA(i);
                          r['text/html'] ? $A(e, t, s, !0) : VA(e, t, !0);
                        });
                      })));
                }),
                e.on('dragstart', e => {
                ...
                e.on('dragover dragend', n => {
                  mc(e) && !t.get() && (n.preventDefault(), nT(e, tT(e, n))),
    ...
    dT = e => br(e.dom),
    cT = e => t => _n(Cn(e), t),
    uT = (e, t) => Zn(Cn(e), dT, cT(t)),
    mT = (e, t, n) => {
      const o = new $o(e, t),
        r = n ? o.next.bind(o) : o.prev.bind(o);
      let s = e;
      for (let t = n ? e : r(); t && !iT(t); t = r()) Di(t) && (s = t);
      return s;
    },
    fT = e => {
      const t = ((e, t, n) => {
        const o = el.fromRangeStart(e).getNode(),
          r = ((e, t, n) =>
            Zn(Cn(e), e => (e => hr(e.dom))(e) || n.isBlock($t(e)), cT(t)).getOr(Cn(t)).dom)(
            o,
            t,
            n
          ),
        ...
        return (
          uT(s, r).fold(
            () => {
              lT(s) ? i.setStart(s, 0) : i.setStartBefore(s);
            },
            e => i.setStartBefore(e.dom)
          ),
          uT(a, r).fold(
            () => {
              lT(a) ? i.setEnd(a, a.data.length) : i.setEndAfter(a);
            },
  ...
  const pT = (e, t) => Math.abs(e.left - t),
    hT = (e, t) => Math.abs(e.right - t),
    bT = (e, t) =>
      (e =>
        X(
          e,
    ...
    yT = (e, t, n, o) => {
      const r = e =>
          Di(e.node) ? I.some(e) : Jo(e.node) ? yT(ce(e.node.childNodes), t, n, !1) : I.none(),
        s = (e, s) => {
          const a = ae(e, (e, o) => s(e, t, n) - s(o, t, n));
          return ue(a, r).map(e =>
            o && !lr(e.node) && a.length > 1
              ? ((e, o, s) =>
                  r(o).filter(o => Math.abs(s(e, t, n) - s(o, t, n)) < 2 && lr(o.node)))(
                  e,
                  a[1],
                  s
                ).getOr(e)
    ...
    CT = (e, t, n) =>
      ((e, t, n) => {
        ...
        .filter(e => ou(e.node))
        .map(e =>
          ((e, t) => ({ node: e.node, position: pT(e, t) < hT(e, t) ? gT.Before : gT.After }))(e, t)
        ),
    wT = e => {
      var t, n;
    ...
    xT = (e, t, n, o) => {
      const r = ((e, t) => {
        ...
        return (
          'dragstart' === t ? (iA(n), gA(n)) : 'drop' === t ? (lA(n), pA(n)) : (dA(n), hA(n)), n
        );
      })(n, e);
      return v(o)
        ? ((e, t, n) => {
        ...
        : ((e, t, n, o) => ({ ...t, dataTransfer: o, type: e, ...ET(n) }))(e, o, t, r);
    },
    ST = br,
    _T = (
      (...e) =>
    ...
    PT = (e, t, n, o, r) => {
      'dragstart' === t && xA(o, e.dom.getOuterHTML(n));
      const s = xT(t, n, o, r);
          ...
          if (e.dragging) {
            const s = r.currentTarget === t.getDoc().documentElement,
              l = ((e, t) => ({ pageX: t.pageX - e.relX, pageY: t.pageY + 5 }))(
                ...
                ((e, t) => {
                  return (
                    (n = (e => (e.inline ? wT(e.getBody()) : { left: 0, top: 0 }))(e)),
                    (o = (e => {
                      const t = e.getBody();
                      return e.inline
                    ...
                    (r = ((e, t) => {
                      if (t.target.ownerDocument !== e.getDoc()) {
                        const n = wT(e.getContentAreaContainer()),
                          o = (e => {
                            const t = e.getBody(),
                  ...
                  e.intervalId.clear(),
                    e.dragging &&
                      ...
                      (a + 8 >= g
                        ...
                        : h - 16 <= 0
                        ? e.intervalId.set(TT(window))
                        : b + 16 >= window.innerWidth
                        ? e.intervalId.set(AT(window))
                        : b - 16 <= 0 && e.intervalId.set(RT(window)));
                });
              })(
                e.ghost,
                l,
    ...
    LT = (e, t, n) => {
      e.on(e => {
        e.intervalId.clear(),
          e.dragging &&
            n.fold(
              () => PT(t, 'dragend', e.element, e.dataTransfer),
              n => PT(t, 'dragend', e.element, e.dataTransfer, n)
            );
      }),
        MT(e);
    },
    ...
    IT = e => {
      const t = Dr(),
        ...
        r = ((e, t) => n => {
          if ((e => 0 === e.button)(n)) {
            ...
            if (
              C(o) &&
              ((e, t, n) => ST(n) && n !== t && e.isEditable(n.parentElement))(
                t.dom,
                t.getBody(),
                o
              )
              ...
              e.set({
                ...
                ghost: kT(t, o, o.offsetWidth, o.offsetHeight),
                intervalId: Pr(100),
              });
            }
          }
              ...
              if (
                ...
                const r =
                  null !== (o = t.getDoc().elementFromPoint(n.clientX, n.clientY)) && void 0 !== o
                    ? o
                    : t.getBody();
                PT(t, 'drop', r, e.dataTransfer, n).isDefaultPrevented() ||
                  t.undoManager.transact(() => {
                    ((e, t) => {
                      const n = e.getParent(t.parentNode, e.isBlock);
                      BT(t), n && n !== e.getRoot() && e.isEmpty(n) && Ja(Cn(n));
                    })(t.dom, e.element),
                      (e => {
      ...
      e.on('mousedown', r),
        ...
        e.on('keydown', n => {
          n.keyCode === Qf.ESC && LT(t, e, I.none());
        });
    },
    FT = br,
    UT = (e, t) => bb(e.getBody(), t),
    zT = e => {
      const t = e.selection,
        n = e.dom,
        o = e.getBody(),
        ...
        a = 'data-mce-selected';
      let i;
      const l = e => e !== o && (FT(e) || wr(e)) && n.isChildOf(e, o) && n.isEditable(e.parentNode),
        d = (n, o, s, a = !0) =>
        ...
        gw(e) ||
          ...
          e.on(
            ...
            t => {
              const n = t.target,
                o = UT(e, n);
              FT(o) ? (t.preventDefault(), JE(e, o).each(f)) : l(n) && JE(e, n).each(f);
            },
            !0
          ),
          e.on('mousedown', r => {
            ...
            const a = UT(e, s);
            FT(a)
              ? (r.preventDefault(), JE(e, a).each(f))
              : CT(o, r.clientX, r.clientY).each(n => {
                  var o;
                  r.preventDefault(),
                    (o = d(1, n.node, n.position === gT.Before, !1)) && t.setRng(o),
                    er(a) ? a.focus() : e.getBody().focus();
                });
          }),
          e.on('keypress', e => {
            Qf.modifierPressed(e) || (FT(t.getNode()) && e.preventDefault());
          }),
    ...
    YT = (e, t) => I.from(e.dom.getParent(t.startContainer, e.dom.isBlock)),
    GT = (e, t, n) => {
    ...
    ZT = (e, t) => e.create('span', { 'data-mce-type': 'bookmark', id: t }),
    QT = (e, t) => {
      const n = e.createRng();
      return n.setStartAfter(t.start), n.setEndBefore(t.end), n;
    },
    JT = (e, t, n) => {
      const o = qT(e.getRoot(), n).getOrDie('Unable to resolve path range'),
        r = o.startContainer,
        s = o.endContainer,
      ...
      return {
        prefix: t,
        end: a.parentNode.insertBefore(ZT(e, t + '-end'), a),
        start: l.insertBefore(ZT(e, t + '-start'), i),
      };
    },
    eO = (e, t, n) => {
      WT(e, e.get(t.prefix + '-end'), n), WT(e, e.get(t.prefix + '-start'), n);
    },
    tO = e => 0 === e.start.length,
    nO = (e, t, n, o) => {
      const r = t.start;
      var s;
      return hk(
    ...
    oO = (e, t, n, o) => {
      const r = e.dom,
        ...
        l = n.position.offset;
      return gk(i, l - n.pattern.end.length, t).bind(d => {
        const c = $T(r, s, d.container, d.offset, i, l, o);
        if (tO(a))
          return I.some({ matches: [{ pattern: a, startRng: c, endRng: c }], position: d });
        {
          ...
          return m.map(e => {
            const t = ((e, t, n, o = !1) =>
              $T(e, t, n.startContainer, n.startOffset, n.endContainer, n.endOffset, o))(
              r,
              s,
              e,
              o
            ...
            return {
              ...
              position: ck(e.startContainer, e.startOffset),
            };
          });
        }
      });
    ...
    rO = (e, t, n, o, r, s) => {
      const a = e.dom;
      return fk(n, o, a.getRoot()).bind(i => {
        const l = XT(a, r, n, o);
        for (let a = 0; a < t.length; a++) {
          const d = t[a];
          ...
          if (u.isNone() && o > 0) return rO(e, t, n, o - 1, r, s);
    ...
    aO = (e, t, n, o, r, s) => {
      ...
      return ((e, t) => {
        ...
        rO(e, r.inlinePatterns, n, o, t, s).fold(
          () => [],
          e => e.matches
        ),
        rO(
    ...
    iO = (e, t) => {
        ...
        r = ((e, t) => {
          const n = La('mce_textpattern'),
            o = G(
              t,
              (t, o) => {
                const r = JT(e, n + `_end${t.length}`, o.endRng);
          ...
          return G(
            ...
            (t, r) => {
              const s = o.length - t.length - 1,
                a = tO(r.pattern) ? r.endMarker : JT(e, n + `_start${s}`, r.startRng);
      ...
      q(r, t => {
        ...
        tO(t.pattern)
          ...
          eO(n, t.endMarker, r),
          eO(n, t.startMarker, r);
      }),
        e.selection.moveToBookmark(o);
    },
    lO = (e, t, n) =>
      ((e, t, n) => {
        if (lr(e) && 0 >= e.length) return I.some(ck(e, 0));
        {
          const t = za(uk);
        ...
        const r = o.container;
        return (
          pk(r, n.start.length, t).each(n => {
            const o = e.createRng();
            o.setStart(r, 0), o.setEnd(n.container, n.offset), KT(e, o, e => e === t);
          }),
          r
        );
      }),
    dO = e => (t, n) => {
      const o = t.dom,
        r = n.pattern,
        s = qT(o.getRoot(), n.range).getOrDie('Unable to resolve path range');
      return (
        YT(t, s).each(n => {
          'block-format' === r.type
            ? ((e, t) => {
        ...
        ? e(r.blockPatterns, a)
            .map(e =>
              t && Dt.trim(a).length === e.start.length
                ? []
                : [{ pattern: e, range: $T(l, l.getRoot(), o, 0, o, 0, s) }]
            )
            .getOr([])
        : [];
    },
    ...
    fO = cO((e, t, n) => 0 === t.indexOf(e.start) || 0 === n.indexOf(e.start)),
    gO = uO(fO, !0),
    pO = dO(lO),
    hO = cO((e, t, n) => t === e.start || n === e.start),
    bO = uO(hO, !1),
    vO = (e, t, n) => {
    ...
    yO = e => {
                  ...
                  return YT(e, n)
                    .map(o => {
                      ...
                      const s = Math.max(0, n.startOffset),
                        a = GT(t, o, null !== (r = o.textContent) && void 0 !== r ? r : '');
                      return {
                        inlineMatches: aO(e, o, n.startContainer, s, a, !0),
                        blockMatches: gO(e, o, a, !0),
                      };
                    })
                    .filter(
                      ...
                      () => {
                        (e => {
                          ...
                          ((e, t) => {
                            if (0 === t.length) return;
                            const n = e.selection.getBookmark();
                            q(t, t => mO(e, t)), e.selection.moveToBookmark(n);
                          })(e, n);
                        const o = e.selection.getRng(),
                          r = fk(o.startContainer, o.startOffset, e.dom.getRoot());
                        e.execCommand('mceInsertNewLine'),
                          r.each(t => {
                            const n = t.container;
                            n.data.charAt(t.offset - 1) === Vo &&
                              (n.deleteData(t.offset - 1, 1),
                              WT(e.dom, n.parentNode, t => t === e.dom.getRoot()));
                          });
                      }
                    ),
                    !0
            ...
            ((e, t) => {
              ...
              YT(e, n).map(o => {
                const r = Math.max(0, n.startOffset - 1),
                  s = XT(e.dom, o, n.startContainer, r),
                  a = GT(t, o, s),
                  i = aO(e, o, n.startContainer, r, a, !1);
                i.length > 0 &&
                  e.undoManager.transact(() => {
                    iO(e, i);
                  });
      ...
      e.on('keyup', e => {
        vO(n, e, (e, t) => e === t.keyCode && !Qf.modifierPressed(t)) && s();
      }),
        e.on('keypress', n => {
          vO(t, n, (e, t) => e.charCodeAt(0) === t.charCode) && Uf.setEditorTimeout(e, s);
        });
    },
    CO = e => {
      const t = Dt.each,
    ...
    wO = ma.DOM,
    EO = e => (e.inline ? e.getElement().nodeName.toLowerCase() : void 0),
    xO = e => Ce(e, e => !1 === v(e)),
    SO = e => {
    ...
    kO = e => (e.inline ? e.ui.styleSheetLoader : e.dom.styleSheetLoader),
    NO = e => {
      const t = kO(e),
        n = Sd(e),
        o = e.contentCSS,
          ...
          ((e, t, n) => {
            const { pass: o, fail: r } = K(t, e => tinymce.Resource.has(mE(e))),
              s = o.map(t => {
                ...
                return m(n) ? Promise.resolve(kO(e).loadRawCss(t, n)) : Promise.resolve();
              }),
              a = [...s, kO(e).loadAll(r)];
    ...
    RO = e => {
      !0 !== e.removed &&
        ((e => {
          gw(e) || e.load({ initial: !0, format: 'html' }),
    ...
    AO = e => {
      ...
      let n = e.getDoc();
      e.inline &&
        (wO.addClass(t, 'mce-content-body'),
      ...
      (o.disabled = !0),
        ...
        !jc(e) &&
          e.hasEditableRoot() &&
          (e.inline &&
            'static' === wO.getStyle(o, 'position', !0) &&
        ...
        (e.formatter = OE(e)),
        (e.undoManager = PE(e)),
        (e._nodeChangeDispatcher = new oA(e)),
        (e._selectionOverrides = zT(e)),
        (e => {
          const t = Dr(),
            n = Br(!1),
            o = wa(t => {
            ...
            e.on('BeforeSetContent', t => {
              ((e, t, n) => {
                let o = t.length,
                  r = n.content;
                if ('raw' !== n.format) {
                  for (; o--; ) r = r.replace(t[o], h_(e, r, _c(e)));
                  n.content = r;
                }
              })(e, a, t);
            }),
        ...
        gw(e) ||
          ((e => {
            e.on('mousedown', t => {
              t.detail >= 3 && (t.preventDefault(), fT(e));
            });
          })(e),
          (e => {
            yO(e);
          ...
          e.on('NodeChange', () =>
            (e => {
              ...
              if (
                ...
                ((e, t, n) => $(jp(Cn(n), Cn(t)), t => c_(e, t.dom)))(r, a, s)
              )
                return;
                ...
                if ((Jo(m) && Kr(o, m), u_(o, m))) {
                  ...
                  if (!i) {
                    if (
                      (!d &&
                        e.hasFocus() &&
                        (d = px(e.selection.getRng(), () => document.createElement('span'))),
                      !m.parentNode)
                    ) {
                      m = null;
                      break;
              ...
              d && (e.selection.setRng(hx(d)), e.nodeChanged());
            })(e)
          );
        })(e),
        (e => {
          ...
          const n = e.dom,
            ...
            s = (t, a) => {
              if (
                (e => {
                  if (ME(e)) {
                    ...
                    return (
                      !IE(e) &&
                      (Qf.metaKeyPressed(e) || e.altKey || (t >= 112 && t <= 123) || H(DE, t))
                    );
                  }
                  return !1;
                })(t)
              ...
              const i = e.getBody(),
                l =
                  !(e => ME(e) && !(IE(e) || ('keyup' === e.type && 229 === e.keyCode)))(t) &&
                  ((e, t, n) => {
              ...
              (('' !== n.getAttrib(i, LE)) !== l || a) &&
                (n.setAttrib(i, LE, l ? r : null),
                ((e, t) => {
      ...
      (e => {
        ...
        (e => {
          ...
          dc(e) || ((t.body.spellcheck = !1), wO.setAttrib(n, 'spellcheck', 'false')),
          (e.quirks = CO(e)),
          (e => {
          ...
          t => {
            e.setProgressState(!0),
              NO(e).then(() => {
                t().then(
                  t => {
                    e.setProgressState(!1), RO(e), bw(e);
                  },
                  t => {
                    e.notificationManager.open({ type: 'error', text: String(t) }), RO(e), bw(e);
                  }
                );
              });
          }
    ...
    OO = ma.DOM,
    BO = ma.DOM,
    PO = (e, t) => ({ editorContainer: e, iframeContainer: t, api: {} }),
    DO = e => {
      const t = e.getElement();
      return e.inline
        ? PO(null)
        : (e => {
            ...
            return BO.insertAfter(t, e), PO(t, t);
          })(t);
    },
    LO = async e => {
      e.dispatch('ScriptsLoaded'),
        (e => {
          const t = Dt.trim(cd(e)),
            ...
            o = { ...zw.get('default').icons, ...zw.get(t).icons };
          pe(o, (t, o) => {
        ...
        (e => {
          ...
          if (m(t)) {
            ...
            (e.theme = n(e, Xw.urls[t]) || {}),
              w(e.theme.init) &&
                e.theme.init(e, Xw.urls[t] || e.documentBaseUrl.replace(/\/$/, ''));
          } else e.theme = {};
        })(e),
        (e => {
          const t = Dd(e),
              ...
              if (((n = Dt.trim(n)), o && -1 === Dt.inArray(t, n))) {
                ...
                try {
                  ...
                  ((e, t, n) => {
                    ...
                    Pl(e, 'PluginLoadError', { message: o }), nE(o, n), Jw(e, o);
                  })(e, n, t);
                }
              }
            })(e, t, (e => e.replace(/^\-/, ''))(n));
      ...
      ((e, t) => {
        ...
        ((e, t, n) => {
          const o = FO(t, 'default', n),
            r = (e =>
              I.from(ud(e))
                .filter(Ge)
                .map(e => ({ url: e, name: I.none() })))(t).orThunk(() => FO(t, cd(t), ''));
          q(
            (e => {
              const t = [],
                n = e => {
        ...
        ((e, t) => {
          ...
          pe(Jd(e), (t, o) => {
            ...
            q(Qd(e), e => {
              !(e = Dt.trim(e)) || Gw.urls[e] || IO(e) || n(e, `plugins/${e}/plugin${t}.js`);
            });
        })(e, t),
      ...
      const a = e ? { mobile: WO(null !== (s = r.mobile) && void 0 !== s ? s : {}, t) } : {},
        ...
        l = Dt.extend(
          ...
          ((e, t) => e && qO(t, 'mobile'))(e, i)
            ...
            : {},
          { external_plugins: KO(o, i.options()) }
        );
      return ((e, t, n, o) => {
        const r = $O(n.forced_plugins),
          s = $O(o.plugins),
          a = ((e, t) => (qO(e, t) ? e.sections()[t] : {}))(t, 'mobile'),
          i = ((e, t, n, o) => (e && qO(t, 'mobile') ? o : n))(
            e,
            t,
            s,
            a.plugins ? $O(a.plugins) : s
          ),
          l = ((e, t) => [...$O(e), ...$O(t)])(r, i);
    ...
    ZO = (e, t) => {
      if (e.selection.isEditable()) {
        ...
        UC(e, { ...o, content: XO(e, n), format: 'html', set: !1, selection: !0 }).each(t => {
          const n = ((e, t, n) => pw(e).editor.insertContent(t, n))(e, t.content, o);
          zC(e, n, t), e.addVisual();
        });
      }
    },
    QO = { 'font-size': 'size', 'font-family': 'face' },
    JO = Zt('font'),
    eB = e => (t, n) =>
      I.from(n)
        .map(Cn)
        ...
        .bind(n =>
          ((e, t, n) =>
            Vb(
              Cn(n),
              t =>
                (t => mo(t, e).orThunk(() => (JO(t) ? xe(QO, e).bind(e => nn(t, e)) : I.none())))(
                  t
                ),
              e => _n(Cn(t), e)
        ...
        .getOr(''),
    tB = eB('font-size'),
    nB = _(e => e.replace(/[\'\"\\]/g, '').replace(/,\s+/g, ','), eB('font-family')),
    oB = e =>
      Zu(e.getBody()).bind(e => {
        const t = e.container();
      ...
      GO(e),
        ...
        (e => {
          e.editorCommands.addCommands({
            ...
            e.editorCommands.addCommands({ Outdent: () => n_(e) }, 'state');
        })(e),
        (e => {
          e.editorCommands.addCommands({
          ...
          (e => {
            ...
            e.editorCommands.addCommands({
              ...
              FontName: (t, n, o) => {
                ((e, t) => {
                  const n = sB(e, t);
                  e.formatter.toggle('fontname', { value: aB(n) }), e.nodeChanged();
                })(e, o);
              },
              FontSize: (t, n, o) => {
                ((e, t) => {
                  e.formatter.toggle('fontsize', { value: sB(e, t) }), e.nodeChanged();
                })(e, o);
              },
              LineHeight: (t, n, o) => {
                ((e, t) => {
            ...
            (e => {
              ...
              e.editorCommands.addCommands(
                ...
                e.editorCommands.addQueryValueHandler('FontName', () =>
                  (e => rB(e, t => nB(e.getBody(), t.dom)).getOr(''))(e)
                ),
                e.editorCommands.addQueryValueHandler('FontSize', () =>
                  (e => rB(e, t => tB(e.getBody(), t.dom)).getOr(''))(e)
                ),
                ...
                e.removed ||
                  (t
                    ...
                    : (e => {
                        ...
                        e.inline || (Tt.browser.isOpera() || Yf(n), e.getWin().focus()),
                          (Tt.browser.isFirefox() || e.inline) && (Yf(n), Kf(e, o)),
                          Zf(e);
                      })(e));
              })(e, !0 === o);
            },
  ...
  class uB {
    ...
    queryCommandState(e) {
      if ((!cB(e) && this.editor.quirks.isHidden()) || this.editor.removed) return !1;
      const t = e.toLowerCase(),
        n = this.commands.state[t];
      return !!w(n) && n(t);
    }
    queryCommandValue(e) {
      if ((!cB(e) && this.editor.quirks.isHidden()) || this.editor.removed) return '';
      const t = e.toLowerCase(),
  ...
  const gB = e => (
      e._eventDispatcher ||
        (e._eventDispatcher = new fB({
          scope: e,
          toggleEvent: (t, n) => {
            fB.isNative(t) && e.toggleNativeEvent && e.toggleNativeEvent(t, n);
          },
        })),
      e._eventDispatcher
    ),
    pB = {
      ...
      on(e, t, n) {
        return gB(this).on(e, t, n);
      },
      off(e, t) {
        return gB(this).off(e, t);
      },
      once(e, t) {
        return gB(this).once(e, t);
      },
      hasEventListeners(e) {
        return gB(this).has(e);
      },
    },
    hB = ma.DOM;
  let bB;
  const vB = (e, t) => {
      ...
      const n = Td(e);
      return n ? (e.eventRoot || (e.eventRoot = hB.select(n)[0]), e.eventRoot) : e.getBody();
    },
    yB = (e, t, n) => {
      (e => !e.hidden && !iE(e))(e)
        ? e.dispatch(t, n)
        : iE(e) &&
          ((e, t) => {
            if ((e => 'click' === e.type)(t) && !Qf.metaKeyPressed(t)) {
              const n = Cn(t.target);
              ((e, t) => to(t, 'a', t => _n(t, Cn(e.getBody()))).bind(e => nn(e, 'href')))(
                e,
                n
              ).each(n => {
            ...
            } else (e => H(uE, e.type))(t) && e.dispatch(t.type, t);
          })(e, n);
    },
    CB = (e, t) => {
        ...
        'focus' !== e &&
          ...
          (n.removed ||
            (t
              ...
              : n.initialized &&
                n.delegates &&
                (n.dom.unbind(vB(n, e), e, n.delegates[e]), delete n.delegates[e])));
      },
    ...
    xB = (e, t) => e + (Xe(t.message) ? '' : `. ${t.message}`),
    SB = e => e.valid,
    _B = (e, t, n = '') => {
      const o = t(e);
      ...
      r.deactivate(),
        r.editorReadOnly !== s.editorReadOnly &&
          ((e, t) => {
            const n = Cn(e.getBody());
            t
              ? ((e.readonly = !0), e.hasEditableRoot() && (n.dom.contentEditable = 'true'), sE(e))
              : ((e.readonly = !1), aE(e));
          })(e, s.editorReadOnly),
        t.set(o),
        ((e, t) => {
      ...
      return (
        (e => {
          e.on('beforeinput paste cut dragend dragover draggesture dragdrop drop drag', t => {
            kB(e) && t.preventDefault();
          }),
            e.on('BeforeExecCommand', t => {
              ('Undo' !== t.command && 'Redo' !== t.command) || !kB(e) || t.preventDefault();
            }),
            e.on('input', t => {
              if (!t.isComposing && kB(e)) {
        ...
        })(e),
        {
          ...
          register: (e, t) => {
            n.set(
              ((e, t, n) => {
                if (H(NB, t)) throw new Error(`Cannot override default mode ${t}`);
                return {
                  ...e,
                  [t]: {
                    ...n,
    ...
    DB = e => {
      ...
      TB(OB(e.toLowerCase(), '+'), e => {
        (e => e in PB)(e)
          ? (t[e] = !0)
          : /^[0-9]{2,}$/.test(e)
          ? (t.keyCode = parseInt(e, 10))
          : ((t.charCode = e.charCodeAt(0)), (t.keyCode = BB[e] || e.toUpperCase().charCodeAt(0)));
      });
      const o = [t.keyCode];
      let r;
  ...
  class zB {
    constructor(e, t, n) {
      ...
      (this.options = ((e, t, n = t) => {
        const o = {},
          ...
          s = (e, t, n) => {
            ...
            return SB(o)
              ? ((r[e] = o.value), !0)
              : (console.warn(xB(`Invalid value passed for the ${e} option`, o)), !1);
          },
          a = e => Se(o, e);
        return {
          register: (e, n) => {
            const a = (e => m(e.processor))(n)
                ? (e => {
                    ...
                    return n => _B(n, t, `The value must be a ${e}.`);
                  })(n.processor)
                : n.processor,
              i = ((e, t, n) => {
                if (!v(t)) {
        ...
        (e => {
          ...
          t('id', { processor: 'string', default: e.id }),
            ...
            e.on('ScriptsLoaded', () => {
              t('directionality', { processor: 'string', default: va.isRtl() ? 'rtl' : void 0 }),
                t('placeholder', {
                  processor: 'string',
      ...
      C(d) && ma.DOM.styleSheetLoader._setContentCssCors(d),
        ...
        (this.inline = Hd(o)),
        (this.hasVisual = tc(o)),
        (this.shortcuts = new LB(this)),
        (this.editorCommands = new uB(this)),
        lB(this);
    ...
    render() {
      (e => {
        ...
        va.setCode(vd(e));
        const n = () => {
          MO.unbind(window, 'ready', n), e.render();
        };
        if (!na.Event.domLoaded) return void MO.bind(window, 'ready', n);
        ...
        e.on('remove', () => {
          ...
          (e.ui.styleSheetLoader = ((e, t) =>
            rs.forElement(e, { contentCssCors: Zd(t), referrerPolicy: bd(t) }))(o, e)),
          Hd(e)
            ? (e.inline = !0)
            : ((e.orgVisibility = e.getElement().style.visibility),
              (e.getElement().style.visibility = 'hidden'));
        const s = e.getElement().form || MO.getParent(t, 'form');
        s &&
          ((e.formElement = s),
          $d(e) &&
            !ir(e.getElement()) &&
            (MO.insertAfter(MO.create('input', { type: 'hidden', name: t }), t),
            (e.hasHiddenInput = !0)),
          (e.formEventDelegate = t => {
            e.dispatch(t.type, t);
          }),
          MO.bind(s, 'submit reset', e.formEventDelegate),
          e.on('reset', () => {
            e.resetContent();
          }),
          !Vd(e) ||
          ...
          (e => 'xml' === e.options.get('encoding'))(e) &&
            e.on('GetContent', e => {
              e.save && (e.content = MO.encode(e.content));
            }),
          qd(e) &&
            e.on('submit', () => {
    ...
    insertContent(e, t) {
      t && (e = FB({ content: e }, t)), this.execCommand('mceInsertContent', !1, e);
    }
    resetContent(e) {
      void 0 === e ? kw(this, this.startContent, { format: 'raw' }) : kw(this, e),
    ...
    setEditableRoot(e) {
      ((e, t) => {
        e._editableRoot !== t &&
          ((e._editableRoot = t),
          iE(e) || ((e.getBody().contentEditable = String(e.hasEditableRoot())), e.nodeChanged()),
          ((e, t) => {
  ...
  const WB = e => {
    ...
    KB = e => {
      if (e !== VB) {
        const t = ma.DOM;
        e
          ? (t.bind(window, 'resize', WB), t.bind(window, 'scroll', WB))
          : (t.unbind(window, 'resize', WB), t.unbind(window, 'scroll', WB)),
          (VB = e);
      }
    },
    YB = e => {
      ...
      return (
        (qB = Y(qB, t => e !== t)),
        XB.activeEditor === e && (XB.activeEditor = qB.length > 0 ? qB[0] : null),
        XB.focusedEditor === e && (XB.focusedEditor = null),
        t.length !== qB.length
      );
    },
    GB = 'CSS1Compat' !== document.compatMode,
    XB = {
      ...pB,
      baseURI: null,
      baseURL: null,
            ...
            0 === i.length
              ...
              : HB(i, s => {
                  ((e, t) => e.inline && t.tagName.toLowerCase() in o)(e, s)
                    ? nE('Could not initialize inline editor on invalid inline target element', s)
                    : ((e, o, s) => {
                        const l = new zB(e, o, t);
                        a.push(l),
                          l.on('init', () => {
                            ++n === i.length && r(a);
                          }),
      ...
      createEditor(e, t) {
        return this.add(new zB(e, t, this));
      },
      remove(e) {
        const t = this;
        let n;
            ...
            return (
              ...
              h(t.get(n.id))
                ...
                : (YB(n) && t.dispatch('RemoveEditor', { editor: n }),
                  0 === qB.length && window.removeEventListener('beforeunload', $B),
                  n.remove(),
                  KB(qB.length > 0),
                  n)
            );
        ...
        } else for (let e = qB.length - 1; e >= 0; e--) t.remove(qB[e]);
      },
      execCommand(e, t, n) {
        var o;
        const r = this,
  ...
  const ZB = (() => {
    ...
    nP = (e, t, n, o) => ({ x: e, y: t, w: n, h: o }),
    oP = {
      inflate: (e, t, n) => nP(e.x - t, e.y - n, e.w + 2 * t, e.h + 2 * n),
      relativePosition: tP,
      ...
      intersect: (e, t) => {
        const n = JB(e.x, t.x),
          o = JB(e.y, t.y),
          r = QB(e.x + e.w, t.x + t.w),
          s = QB(e.y + e.h, t.y + t.h);
        return r - n < 0 || s - o < 0 ? null : nP(n, o, r - n, s - o);
      },
      clamp: (e, t, n) => {
        let o = e.x,
          r = e.y,
      ...
      create: nP,
      fromClientRect: e => nP(e.left, e.top, e.width, e.height),
    },
    rP = (() => {
      const e = {},
        t = {},
  ...
  const aP = {
      ...
      util: {
        ...
        ImageUploader: e => {
          const t = pE(),
            n = yE(e, t);
          return { upload: (t, o = !0) => n.upload(t, o ? vE(e) : void 0) };
        },
      },
      dom: {
        EventUtils: na,
